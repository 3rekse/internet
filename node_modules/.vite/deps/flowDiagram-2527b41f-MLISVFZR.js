import {
  ...
  we,
  ye
} from "./chunk-HVBMRDZI.js";
import "./chunk-6GOXKZ2Q.js";
import {
  Ye,
  ze
} from "./chunk-MCZJXL4B.js";
import "./chunk-64ZQB7KM.js";
import "./chunk-S37YXH5X.js";
import {
  D,
  L,
  Un,
...
// node_modules/mermaid/dist/flowDiagram-2527b41f.js
function Dt(r) {
  if (!r.ok)
...
var bt = function(r, e, t, n, a, s) {
  ...
  Object.keys(r).forEach(function(d) {
    ...
    if (Ta(Ft().flowchart.htmlLabels)) {
      ...
      const k = u.split(In.lineBreakRegex);
      for (const I of k) {
    ...
    L2.warn("Adding node", l.id, l.domId), e.setNode(s.db.lookUpDomId(l.id), {
      labelType: "svg",
...
var kt = function(r, e, t) {
  ...
  r.forEach(function(i) {
    ...
    l.style = v, l.labelStyle = h, i.interpolate !== void 0 ? l.curve = m0(i.interpolate, $f) : r.defaultInterpolate !== void 0 ? l.curve = m0(r.defaultInterpolate, $f) : l.curve = m0(mt.curve, $f), i.text === void 0 ? i.style !== void 0 && (l.arrowheadStyle = "fill: #333") : (l.arrowheadStyle = "fill: #333", l.labelpos = "c", Ta(Ft().flowchart.htmlLabels) ? (l.labelType = "html", l.label = `<span id="L-${o}" class="edgeLabel L-${c2}' L-${d}" style="${l.labelStyle}">${i.text.replace(
      /fa[blrs]?:fa-[\w-]+/g,
      (u) => `<i class='${u.replace(":", " ")}'></i>`
    )}</span>`) : (l.labelType = "text", l.label = i.text.replace(In.lineBreakRegex, `
...
var xe = function(r, e) {
  return L2.info("Extracting classes"), e.db.getClasses();
};
var me = function(r, e, t, n) {
  L2.info("Drawing flowchart");
  ...
  const k = new de();
  ge.addToRender(k), k.arrows().none = function(b2, L3, x, B) {
    const C = b2.append("marker").attr("id", L3).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerUnits", "strokeWidth").attr("markerWidth", 8).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("d", "M 0 0 L 0 0 L 0 0 z");
    te(C, x[B + "Style"]);
  }, k.arrows().normal = function(b2, L3) {
    b2.append("marker").attr("id", L3).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerUnits", "strokeWidth").attr("markerWidth", 8).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("d", "M 0 0 L 10 5 L 0 10 z").attr("class", "arrowheadPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
  };
  ...
  for (k(E, h), E.selectAll("g.node").attr("title", function() {
    ...
    if (u = p[y], u.title !== "undefined") {
      ...
      ), L3 = w[0].x.baseVal.value, x = w[0].y.baseVal.value, B = w[0].width.baseVal.value, C = Ct(b2[0]).select(".label");
      C.attr("transform", `translate(${L3 + B / 2}, ${x + 14})`), C.attr("id", e + "Text");
  ...
  if (!s.htmlLabels) {
    ...
    for (const b2 of w) {
      const L3 = b2.getBBox(), x = c2.createElementNS("http://www.w3.org/2000/svg", "rect");
      x.setAttribute("rx", 0), x.setAttribute("ry", 0), x.setAttribute("width", L3.width), x.setAttribute("height", L3.height), b2.insertBefore(x, b2.firstChild);
    }
  }
  py(h, I, s.diagramPadding, s.useMaxWidth), Object.keys(g).forEach(function(w) {
    const b2 = g[w];
    if (b2.link) {
      const L3 = o.select("#" + e + ' [id="' + n.db.lookUpDomId(w) + '"]');
      if (L3) {
        const x = c2.createElementNS("http://www.w3.org/2000/svg", "a");
        x.setAttributeNS("http://www.w3.org/2000/svg", "class", b2.classes.join(" ")), x.setAttributeNS("http://www.w3.org/2000/svg", "href", b2.link), x.setAttributeNS("http://www.w3.org/2000/svg", "rel", "noopener"), a === "sandbox" ? x.setAttributeNS("http://www.w3.org/2000/svg", "target", "_top") : b2.linkTarget && x.setAttributeNS("http://www.w3.org/2000/svg", "target", b2.linkTarget);
        const B = L3.insert(function() {
          return x;
        }, ":first-child"), G = L3.select(".label-container");
        G && B.append(function() {
          return G.node();
        });
        const C = L3.select(".label");
        C && B.append(function() {
          return C.node();
        });
      }
...
var Be = {
  ...
  styles: ye,
  init: (r) => {
    r.flowchart || (r.flowchart = {}), r.flowchart.arrowMarkerAbsolute = r.arrowMarkerAbsolute, be2.setConf(r.flowchart), Ye.clear(), Ye.setGen("gen-1");
  }
};
export {
  Be as diagram
};
//# sourceMappingURL=flowDiagram-2527b41f-MLISVFZR.js.map
