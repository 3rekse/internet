...
// node_modules/mermaid/dist/styles-99e04339.js
var gt = function() {
  var t = function(C, r, n, i) {
    ...
    parse: function(r) {
      var n = this, i = [0], o = [], p = [null], e = [], B = this.table, l = "", A = 0, O = 0, st = 2, $ = 1, ft = e.slice.call(arguments, 1), S = Object.create(this.lexer), L2 = { yy: {} };
      for (var dt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, dt) && (L2.yy[dt] = this.yy[dt]);
      S.setInput(r, L2.yy), L2.yy.lexer = S, L2.yy.parser = this, typeof S.yylloc > "u" && (S.yylloc = {});
      var yt = S.yylloc;
      e.push(yt);
      var Gt = S.options && S.options.ranges;
      typeof L2.yy.parseError == "function" ? this.parseError = L2.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function jt() {
        var x;
...
Expecting ` + rt.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : St = "Parse error on line " + (A + 1) + ": Unexpected " + (_ == $ ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(St, {
    ...
    var C = {
      ...
      setInput: function(r, n) {
        return this.yy = n || this.yy || {}, this._input = r, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
...
` + n + "^";
      ...
      next: function() {
        ...
        for (var p = this._currentRules(), e = 0; e < p.length; e++)
          if (i = this._input.match(this.rules[p[e]]), i && (!n || i[0].length > n[0].length)) {
            if (n = i, o = e, this.options.backtrack_lexer) {
              if (r = this.test_match(i, p[e]), r !== false)
                return r;
              if (this._backtrack) {
                n = false;
                continue;
        ...
        return n ? (r = this.test_match(n, p[o]), r !== false ? r : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var nt = (t) => JSON.parse(JSON.stringify(t));
var ne = (t) => {
...
var at = (t, s, a) => {
  if (s.stmt === It)
    at(t, s.state1, true), at(t, s.state2, false);
    ...
    s.doc.forEach((y) => at(s, y, true));
  }
};
var le = () => (at({ id: "root" }, { id: "root", doc: lt }, true), { id: "root", doc: lt });
var ce = (t) => {
  let s;
  t.doc ? s = t.doc : s = t, L.info(s), Pt(true), L.info("Extract", s), s.forEach((a) => {
    switch (a.stmt) {
      case _t:
        I(
          a.id.trim(),
        ...
        break;
      case It:
        Ft2(a.state1, a.state2, a.description);
        break;
      case Qt:
...
var I = function(t, s = Et, a = null, h = null, f = null, d = null, y = null, k = null) {
  ...
  g.states[u] === void 0 ? (L.info("Adding state ", u, h), g.states[u] = {
    ...
    styles: [],
    textStyles: []
  }) : (g.states[u].doc || (g.states[u].doc = a), g.states[u].type || (g.states[u].type = s)), h && (L.info("Setting state description", u, h), typeof h == "string" && kt(u, h.trim()), typeof h == "object" && h.forEach((E) => kt(u, E.trim()))), f && (g.states[u].note = f, g.states[u].note.text = In.sanitizeText(
    g.states[u].note.text,
    Ft()
  )), d && (L.info("Setting state classes", u, d), (typeof d == "string" ? [d] : d).forEach((T) => xt(u, T.trim()))), y && (L.info("Setting state styles", u, y), (typeof y == "string" ? [y] : y).forEach((T) => _e(u, T.trim()))), k && (L.info("Setting state styles", u, y), (typeof k == "string" ? [k] : k).forEach((T) => me(u, T.trim())));
};
var Pt = function(t) {
  ct = {
    root: $t()
  }, g = ct.root, F = 0, P = wt(), t || Ry();
};
var V = function(t) {
  return g.states[t];
};
...
function ye(t, s, a) {
  ...
  I(
    ...
    id1: h,
    id2: d,
    relationTitle: In.sanitizeText(a, Ft())
  });
}
var Ft2 = function(t, s, a) {
  if (typeof t == "object")
    ye(t, s, a);
  else {
...
var Ee = (t) => t && t[0] === ":" ? t.substr(1).trim() : t.trim();
var Ae = {
  getConfig: () => Ft().state,
  addState: I,
  clear: Pt,
...
//# sourceMappingURL=chunk-47BSFOPA.js.map
