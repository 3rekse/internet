...
// node_modules/mermaid/dist/mindmap-definition-5c6cc2b2.js
var Ki = function() {
  var pe = function(j, Y, te, L2) {
    for (te = te || {}, L2 = j.length; L2--; te[j[L2]] = Y)
      ;
    return te;
    ...
    performAction: function(Y, te, L2, $, k, q, he) {
      var ge = q.length - 1;
      switch (k) {
        case 6:
        case 7:
    ...
    parse: function(Y) {
      var te = this, L2 = [0], $ = [], k = [null], q = [], he = this.table, ge = "", Ae = 0, Ne = 0, _e = 2, tt = 1, ct = q.slice.call(arguments, 1), Pe = Object.create(this.lexer), $e = { yy: {} };
      ...
      for (var je, pt, Et, kt, vt = {}, vr, qt, on, Kr; ; ) {
        if (pt = L2[L2.length - 1], this.defaultActions[pt] ? Et = this.defaultActions[pt] : ((je === null || typeof je > "u") && (je = nt()), Et = he[pt] && he[pt][je]), typeof Et > "u" || !Et.length || !Et[0]) {
          var Da = "";
          Kr = [];
          for (vr in he[pt])
...
Expecting ` + Kr.join(", ") + ", got '" + (this.terminals_[je] || je) + "'" : Da = "Parse error on line " + (Ae + 1) + ": Unexpected " + (je == tt ? "end of input" : "'" + (this.terminals_[je] || je) + "'"), this.parseError(Da, {
        ...
        switch (Et[0]) {
          case 1:
            L2.push(je), k.push(Pe.yytext), q.push(Pe.yylloc), L2.push(Et[1]), je = null, Ne = Pe.yyleng, ge = Pe.yytext, Ae = Pe.yylineno, rt = Pe.yylloc;
            break;
          case 2:
            if (qt = this.productions_[Et[1]][1], vt.$ = k[k.length - qt], vt._$ = {
              ...
              return kt;
            qt && (L2 = L2.slice(0, -1 * qt * 2), k = k.slice(0, -1 * qt), q = q.slice(0, -1 * qt)), L2.push(this.productions_[Et[1]][0]), k.push(vt.$), q.push(vt._$), on = he[L2[L2.length - 2]][L2[L2.length - 1]], L2.push(on);
            break;
          case 3:
            return true;
        }
    ...
    var j = {
      EOF: 1,
      parseError: function(te, L2) {
        if (this.yy.parser)
          this.yy.parser.parseError(te, L2);
        else
          throw new Error(te);
      },
      ...
      unput: function(Y) {
        ...
        return this.yylloc = {
          ...
          last_column: L2 ? (L2.length === $.length ? this.yylloc.first_column : 0) + $[$.length - L2.length].length - L2[0].length : this.yylloc.first_column - te
...
` + te + "^";
      ...
      next: function() {
        ...
        for (var k = this._currentRules(), q = 0; q < k.length; q++)
          if (L2 = this._input.match(this.rules[k[q]]), L2 && (!te || L2[0].length > te[0].length)) {
            if (te = L2, $ = q, this.options.backtrack_lexer) {
              if (Y = this.test_match(L2, k[q]), Y !== false)
                return Y;
              if (this._backtrack) {
                te = false;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: function(te, L2, $, k) {
        switch ($) {
          case 0:
            return te.getLogger().trace("Found comment", L2.yytext), 6;
          case 1:
            return 8;
          case 2:
            this.begin("CLASS");
          ...
          case 24:
            ...
            break;
          case 25:
            return te.getLogger().trace("description:", L2.yytext), "NODE_DESCR";
          case 26:
            this.popState();
            break;
          case 27:
          ...
          case 28:
            return this.popState(), te.getLogger().trace("node end )"), "NODE_DEND";
          case 29:
            return this.popState(), te.getLogger().trace("node end ...", L2.yytext), "NODE_DEND";
          case 30:
            return this.popState(), te.getLogger().trace("node end (("), "NODE_DEND";
          case 31:
            return this.popState(), te.getLogger().trace("node end (-"), "NODE_DEND";
          ...
          case 34:
            return this.popState(), te.getLogger().trace("node end (("), "NODE_DEND";
          case 35:
            return te.getLogger().trace("Long description:", L2.yytext), 20;
          case 36:
            return te.getLogger().trace("Long description:", L2.yytext), 20;
        }
      },
...
var Op = (pe, fe) => {
  switch (L.debug("In get type", pe, fe), pe) {
    case "[":
      return yt.RECT;
    case "(":
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var _ = ee(""), Q = ee({}), ne = ee(function() {
      ...
      return L2(e) && k(e.x1) && k(e.x2) && k(e.y1) && k(e.y2);
    }, rt = function(e) {
      return $(e) && Y(e.then);
    }, lt = function() {
    ...
    var Rr = il, Sa = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof sh < "u" ? sh : typeof self < "u" ? self : {};
    function sl(t, e) {
    ...
    var ln = _l, ri = D ? D.performance : null, ss = ri && ri.now ? function() {
      ...
      return e == null ? e : te(e) ? e.slice() : L2(e) ? Kl(e) : e;
    }, Zl = function(e) {
      return e.slice();
    }, ds = function(e, r) {
      for (
      ...
      return e = {
        ...
        var s;
        L2(a) && !ge(a) && (s = a, a = s.roots || s.root, n = s.visit, i = s.directed), i = arguments.length === 2 && !Y(n) ? n : i, n = Y(n) ? n : function() {
        };
        ...
        for (var I = o.collection(), C = 0; C < f.length; C++) {
          var B2 = f[C], F = h[B2.id()];
          F != null && I.push(F), I.push(B2);
        }
        return {
          path: o.collection(I),
    ...
    var rf = sl(function(t, e) {
      (function() {
        ...
        n = Math.floor, h = Math.min, a = function(p, m) {
          ...
          for (m == null && (m = a), A2 = (function() {
            I = [];
            for (var C = 0, B2 = n(p.length / 2); 0 <= B2 ? C < B2 : C > B2; 0 <= B2 ? C++ : C--)
              I.push(C);
            return I;
          ...
          var E, M, A2, w, I, C, B2, F, R;
          if (b == null && (b = a), m * 10 <= p.length) {
            if (A2 = p.slice(0, m).sort(b), !A2.length)
              return A2;
            for (M = A2[A2.length - 1], B2 = p.slice(m), w = 0, C = B2.length; w < C; w++)
              E = B2[w], b(E, M) < 0 && (f(A2, E, 0, null, b), A2.pop(), M = A2[A2.length - 1]);
            return A2;
          }
      ...
      dijkstra: function(e) {
        ...
        for (var M = function(W, Z) {
          ...
          if (c[I] = w, w !== 1 / 0)
            for (var C = A2.neighborhood().intersect(d), B2 = 0; B2 < C.length; B2++) {
              var F = C[B2], R = F.id(), X = M(A2, F), z = w + X.dist;
              z < y(F) && (p(F, z), h[R] = {
                node: A2,
                edge: X.edge
              });
      ...
      aStar: function(e) {
        ...
        for (var w = 0; d.size() > 0; ) {
          if (M(), w++, E === f) {
            for (var I = [], C = i, B2 = f, F = p[B2]; I.unshift(C), F != null && I.unshift(F), C = y[B2], C != null; )
              B2 = C.id(), F = p[B2];
            return {
              found: true,
              distance: h[E],
      ...
      floydWarshall: function(e) {
        ...
        for (var m = new Array(h), b = new Array(h), E = 0; E < u.length; E++) {
          ...
          if (A2 !== w) {
            var I = c(A2), C = c(w), B2 = I * f + C, F = s(M);
            if (d[B2] > F && (d[B2] = F, m[B2] = C, b[B2] = M), !i) {
              var R = C * f + I;
      ...
      bellmanFord: function(e) {
        ...
        for (var C = false, B2 = function(ke, Ge, et, We, Ye, Se) {
          var N = We.dist + Se;
          ...
          for (var R = 0; R < p; R++) {
            ...
            B2(z, re, X, Z, ie, W), i || B2(re, z, X, ie, Z, W);
          }
          if (!C)
            break;
        }
      ...
      kargerStein: function() {
        ...
        for (var c = 1 / 0, v = [], d = new Array(i), g = new Array(i), y = new Array(i), p = function(oe, de) {
          ...
          p(g, y);
          var A2 = si(g, E, l, 2), w = si(y, M, l, 2);
        ...
        for (var I = this.spawn(v.map(function(ie) {
          return n[ie[0]];
        })), C = this.spawn(), B2 = this.spawn(), F = d[0], R = 0; R < d.length; R++) {
          var X = d[R], z = a[R];
          X === F ? C.merge(z) : B2.merge(z);
        }
        var re = function(oe) {
          var de = e.spawn();
      ...
      {
        var I = a - u - o, C = n - f + l - o, B2 = I, F = n + f - l + o;
        if (h = Tr(e, r, a, n, I, C, B2, F, false), h.length > 0)
          return h;
      }
      var R;
      {
      ...
      for (var l = new Array(a.length), u = s / 2, f = o / 2, h = ci2(s, o), c = h * h, v = 0; v < a.length / 4; v++) {
        ...
        var I = a[d + 1], C = -a[d], B2 = I * a[g] + C * a[g + 1];
        B2 < 0 && (I *= -1, C *= -1);
      ...
      for (var u = [], f, h = new Array(a.length), c = s / 2, v = o / 2, d = ci2(s, o), g = 0; g < a.length / 4; g++) {
        ...
        var B2 = a[y + 1], F = -a[y], R = B2 * a[p] + F * a[p + 1];
        R < 0 && (B2 *= -1, F *= -1);
        var X = A2 + B2 * d, z = w + F * d;
      ...
      pageRank: function(e) {
        ...
        for (var E = 0; E < v; E++) {
          ...
          if (A2 !== w) {
            var I = u.indexOfId(A2), C = u.indexOfId(w), B2 = s(M), F = C * h + I;
            d[F] += B2, g[I] += B2;
          }
        }
    ...
    var ah2 = Lt({
      ...
      if (e.length < 50)
        for (var n = 0; n < r; n++) {
          for (var i = e[Math.floor(Math.random() * e.length)]; sh2(i, a, n); )
      ...
      for (var s = 0, o = 1 / 0, l, u = i.attributes, f = function(C, B2) {
      ...
      for (C = 0; C < n.maxIterations; C++) {
        for (var B2 = 0; B2 < o; B2++) {
          for (var F = -1 / 0, R = -1 / 0, X = -1, z = 0, re = 0; re < o; re++)
            b[re] = h[B2 * o + re], z = c[B2 * o + re] + u[B2 * o + re], z >= F ? (R = F, F = z, X = re) : z > R && (R = z);
          for (var W = 0; W < o; W++)
            h[B2 * o + W] = (1 - n.damping) * (u[B2 * o + W] - F) + n.damping * b[W];
          h[B2 * o + X] = (1 - n.damping) * (u[B2 * o + X] - R) + n.damping * b[X];
        }
        for (var Z = 0; Z < o; Z++) {
            ...
            for (var w = 0; w < A2.length; w++) {
              ...
              if (I)
                for (var C = 0; C < u.length; C++) {
                  var B2 = u[C];
                  s.canSet(B2) && (B2._private[s.field][E] = M);
                }
            }
            s.updateStyle && o.updateStyle(), s.onSet(o), s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent);
    ...
    tr = co = {
      ...
      silentShift: function(e, r) {
        return L2(e) ? this.shift(e, true) : j(e) && k(r) && this.shift(e, r, true), this;
      },
      // get/set the rendered (i.e. on screen) positon of the element
      renderedPosition: function(e, r) {
        var a = this[0], n = this.cy(), i = n.zoom(), s = n.pan(), o = L2(e) ? e : void 0, l = o !== void 0 || r !== void 0 && j(e);
        if (a && a.isNode())
          if (l)
      ...
      relativePosition: function(e, r) {
        var a = this[0], n = this.cy(), i = L2(e) ? e : void 0, s = i !== void 0 || r !== void 0 && j(e), o = n.hasCompoundNodes();
        if (a && a.isNode())
          if (s)
    ...
    ca = Ar = {}, Ar.renderedBoundingBox = function(t) {
      ...
      function r(s) {
        ...
        function v(C, B2, F) {
          var R = 0, X = 0, z = B2 + F;
          return C > 0 && z > 0 && (R = B2 / z * C, X = F / z * C), {
            biasDiff: R,
        ...
        function d(C, B2, F, R) {
          if (F.units === "%")
            switch (R) {
              ...
              case "height":
                return B2 > 0 ? F.pfValue * B2 : 0;
              case "average":
                return C > 0 && B2 > 0 ? F.pfValue * (C + B2) / 2 : 0;
              case "min":
                return C > 0 && B2 > 0 ? C > B2 ? F.pfValue * B2 : F.pfValue * C : 0;
              case "max":
                return C > 0 && B2 > 0 ? C > B2 ? F.pfValue * C : F.pfValue * B2 : 0;
              default:
                return 0;
            }
          else
    ...
    var Zt = function(e) {
      ...
      if (!r.cy().headless()) {
        ...
        if (o) {
          ...
          F += d - Math.max(m, E) - M - A2, R += d + Math.max(m, E) + M + A2, X += g - Math.max(m, E) - M - A2, z += g + Math.max(m, E) + M + A2;
      ...
      if (b) {
        ...
        var I = Math.max(M, w), C = 0, B2 = 0;
        if (n && (C = e.pstyle("width").pfValue, B2 = C / 2), l && r.includeNodes) {
          var F = e.position();
          d = F.x, g = F.y;
          ...
          if (n && !i) {
            ...
            if (f = Math.min(y.srcX, y.midX, y.tgtX), h = Math.max(y.srcX, y.midX, y.tgtX), c = Math.min(y.srcY, y.midY, y.tgtY), v = Math.max(y.srcY, y.midY, y.tgtY), f -= B2, h += B2, c -= B2, v += B2, rr(s, f, c, h, v), W === "haystack") {
              var Z = y.haystackPts;
              if (Z && Z.length === 2) {
              ...
              if (de != null)
                for (var se = 0; se < de.length; se++) {
                  var ve = de[se];
                  f = ve.x - B2, h = ve.x + B2, c = ve.y - B2, v = ve.y + B2, rr(s, f, c, h, v);
                }
            }
          } else {
            ...
            f -= B2, h += B2, c -= B2, v += B2, rr(s, f, c, h, v);
          }
    ...
    var Ot = function(e, r) {
      ...
      if (!r)
        r = [];
      else if (r.length > 0 && L2(r[0]) && !Ae(r[0])) {
        s = true;
    ...
    mt.instanceString = function() {
      ...
      for (h = 0; h < o.length; h++) {
        ...
        if (v.isEdge()) {
          ...
          var C = a.getElementById(g.source), B2 = a.getElementById(g.target);
          C.same(B2) ? C._private.edges.push(m) : (C._private.edges.push(m), B2._private.edges.push(m)), m._private.source = C, m._private.target = B2;
        }
    ...
    var Nd = {
      add: function(e) {
        ...
        if (ge(e)) {
          ...
          var l = e;
          r = new Ot(a, l);
        } else if (L2(e) && (te(e.nodes) || te(e.edges))) {
    ...
    function Md(t, e, r, a) {
      ...
      function y(B2, F, R) {
        return ((v(F, R) * B2 + d(F, R)) * B2 + g(F)) * B2;
      }
      function p(B2, F, R) {
        return 3 * v(F, R) * B2 * B2 + 2 * d(F, R) * B2 + g(F);
      }
      function m(B2, F) {
        for (var R = 0; R < n; ++R) {
          var X = p(F, t, r);
      ...
      function E(B2, F, R) {
        var X, z, re = 0;
        do
          z = F + (R - F) / 2, X = y(z, t, r) - B2, X > 0 ? R = z : F = z;
        while (Math.abs(X) > s && ++re < o);
        return z;
      }
      function M(B2) {
        for (var F = 0, R = 1, X = l - 1; R !== X && c[R] <= B2; ++R)
          F += u;
        --R;
        var z = (B2 - c[R]) / (c[R + 1] - c[R]), re = F + z * u, W = p(re, t, r);
        return W >= i ? m(B2, re) : W === 0 ? re : E(B2, F, F + u);
      }
      var A2 = false;
      function w() {
        A2 = true, (t !== e || r !== a) && b();
      ...
      var I = function(F) {
        return A2 || w(), t === e && r === a ? F : F === 0 ? 0 : F === 1 ? 1 : y(M(F), e, a);
      };
    ...
    function Rd(t, e, r, a) {
      ...
      if (s.duration === 0 ? y = 1 : y = (r - l) / s.duration, s.applying && (y = s.progress), y < 0 ? y = 0 : y > 1 && (y = 1), s.delay == null) {
        ...
        var I = s.startZoom, C = s.zoom, B2 = C != null && a;
        B2 && (Xa(I, C) && (i.zoom = ka(i.minZoom, ga(I, C, y, g), i.maxZoom)), t.emit("zoom")), (w || B2) && t.emit("viewport");
        var F = s.style;
        if (F && F.length > 0 && n) {
    ...
    Bt.apply = function(t) {
      ...
      for (var h = function(Oe, Ie) {
        ...
        if (b != null) {
          ...
          var I = E.enums == null ? b.value : null, C = w != null, B2 = I != null, F = C || B2, R = b.units;
      ...
      switch (a.mapped) {
        case s.mapData: {
          ...
          if (E < 0 ? E = 0 : E > 1 && (E = 1), o.color) {
            var A2 = a.valueMin[0], w = a.valueMax[0], I = a.valueMin[1], C = a.valueMax[1], B2 = a.valueMin[2], F = a.valueMax[2], R = a.valueMin[3] == null ? 1 : a.valueMin[3], X = a.valueMax[3] == null ? 1 : a.valueMax[3], z = [Math.round(A2 + (w - A2) * E), Math.round(I + (C - I) * E), Math.round(B2 + (F - B2) * E), Math.round(R + (X - R) * E)];
            i = {
    ...
    lr.getRenderedStyle = function(t, e) {
      ...
      for (var r = {}, a = 0; a < e.length; a++) {
        ...
        s !== void 0 && (L2(s) ? s = this.parse(i, s.strValue) : s = this.parse(i, s)), s && (r[i] = s);
      }
      return r;
    ...
    (function() {
      ...
      var W = Nt.properties = [].concat(g, b, y, p, m, B2, d, v, f, h, c, M, A2, w, R, I, C, z, F), Z = Nt.propertyGroups = {
        // common to all eles
        behavior: g,
        transition: b,
        visibility: y,
    ...
    Vn.parse = function(t, e, r, a) {
      ...
      if (u.multiple && a !== "multiple") {
        ...
        for (var E = [], M = [], A2 = [], w = "", I = false, C = 0; C < b.length; C++) {
          var B2 = n.parse(t, b[C], r, "multiple");
          I = I || j(B2.value), E.push(B2.value), A2.push(B2.pfValue != null ? B2.pfValue : B2.value), M.push(B2.units), w += (C > 0 ? " " : "") + B2.strValue;
        }
    ...
    var $d = {
      ...
      panBy: function(e, r) {
        ...
        switch (a.length) {
          case 1:
            L2(e) && (o = a[0], l = o.x, u = o.y, k(l) && (n.x += l), k(u) && (n.y += u), this.emit("pan viewport"));
            break;
          case 2:
      ...
      getZoomedViewport: function(e) {
        ...
        if (r.zoomingEnabled || (o = true), k(e) ? s = e : L2(e) && (s = e.level, e.position != null ? i = dn(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !r.panningEnabled && (o = true)), s = s > r.maxZoom ? r.maxZoom : s, s = s < r.minZoom ? r.minZoom : s, o || !k(s) || s === n || i != null && (!k(i.x) || !k(i.y)))
          return null;
        if (i != null) {
          var l = a, u = n, f = s, h = {
            x: -f / u * (i.x - l.x) + i.x,
      ...
      viewport: function(e) {
        ...
        if (!e)
          return this;
        if (k(e.zoom) || (a = false), L2(e.pan) || (n = false), !a && !n)
          return this;
        if (a) {
          var l = e.zoom;
    ...
    var Za = function(e) {
      ...
      var l = function(d, g, y) {
        ...
        pan: {
          x: L2(o.pan) && k(o.pan.x) ? o.pan.x : 0,
          y: L2(o.pan) && k(o.pan.y) ? o.pan.y : 0
        },
        animation: {
          // object for currently-running animations
          current: [],
      ...
      var c = function(d, g, y) {
        ...
        p.length > 0 && p.remove(), d != null && (L2(d) || te(d)) && r.add(d), r.one("layoutready", function(b) {
          ...
          if (r.startBatch(), e.elements) {
            var s = {}, o = function(E, M) {
              for (var A2 = [], w = [], I = 0; I < E.length; I++) {
                ...
                var B2 = "" + C.data.id, F = r.getElementById(B2);
                s[B2] = true, F.length !== 0 ? w.push({
                  ele: F,
                  json: C
    ...
    Xo.prototype.run = function() {
      ...
      var E = function(A2, w) {
        var I = e.startAngle + w * u * (n ? 1 : -1), C = f * Math.cos(I), B2 = f * Math.sin(I), F = {
          x: o.x + C,
          y: o.y + B2
        };
        return F;
    ...
    var Xd = function(e, r, a) {
      ...
      for (var u = 0; u < s.edgeSize; u++) {
        var B2 = n[u], F = {};
        F.id = B2.data("id"), F.sourceId = B2.data("source"), F.targetId = B2.data("target");
        var R = Y(a.idealEdgeLength) ? a.idealEdgeLength(B2) : a.idealEdgeLength, X = Y(a.edgeElasticity) ? a.edgeElasticity(B2) : a.edgeElasticity, z = s.idToIndex[F.sourceId], re = s.idToIndex[F.targetId], W = s.indexToGraph[z], Z = s.indexToGraph[re];
        if (W != Z) {
      ...
      if (i.h === 0 || i.w === 0)
        ...
        if (e.condense && (m = 0, b = 0), e.avoidOverlap)
          for (var E = 0; E < n.length; E++) {
            ...
            var w = M.layoutDimensions(e), I = e.avoidOverlapPadding, C = w.w + I, B2 = w.h + I;
            m = Math.max(m, C), b = Math.max(b, B2);
          }
    ...
    Vr.projectIntoViewport = function(t, e) {
      ...
      function p(w) {
        var I = w.outerWidth() + 2 * h, C = w.outerHeight() + 2 * h, B2 = I / 2, F = C / 2, R = w.position();
        if (R.x - B2 <= t && t <= R.x + B2 && R.y - F <= e && e <= R.y + F) {
      ...
      function m(w) {
        var I = w._private, C = I.rscratch, B2 = w.pstyle("width").pfValue, F = w.pstyle("arrow-scale").value, R = B2 / 2 + f, X = R * R, z = R * 2, ie = I.source, oe = I.target, re;
        ...
        for (var ie = ie || I.source, oe = oe || I.target, de = n.getArrowWidth(B2, F), se = [{
          name: "source",
          x: C.arrowStartX,
          y: C.arrowStartY,
      ...
      function E(w, I) {
        var C = w._private, B2 = c, F;
        I ? F = I + "-" : F = "", w.boundingBox();
        var R = C.labelBounds[I || "main"], X = w.pstyle(F + "label").value, z = w.pstyle("text-events").strValue === "yes";
        if (!(!z || !X)) {
          var re = b(C.rscratch, "labelX", I), W = b(C.rscratch, "labelY", I), Z = b(C.rscratch, "labelAngle", I), ie = w.pstyle(F + "text-margin-x").pfValue, oe = w.pstyle(F + "text-margin-y").pfValue, de = R.x1 - B2 - ie, se = R.x2 + B2 - ie, ve = R.y1 - B2 - oe, we = R.y2 + B2 - oe;
          if (Z) {
    ...
    Hn.calculateArrowAngles = function(t) {
      ...
      if (r && (p = (f + c) / 2, m = (h + v) / 2), l = c - f, u = v - h, i) {
        ...
        var d = e.allpts, A2 = e.ctrlpts, w, I, C, B2;
        if (A2.length / 2 % 2 === 0) {
          var F = d.length / 2 - 1, R = F + 2, X = R + 2;
          w = St(d[F], d[R], d[X], 0), I = St(d[F + 1], d[R + 1], d[X + 1], 0), C = St(d[F], d[R], d[X], 1e-4), B2 = St(d[F + 1], d[R + 1], d[X + 1], 1e-4);
        } else {
          var R = d.length / 2 - 1, F = R - 2, X = R + 2;
          w = St(d[F], d[R], d[X], 0.4999), I = St(d[F + 1], d[R + 1], d[X + 1], 0.4999), C = St(d[F], d[R], d[X], 0.5), B2 = St(d[F + 1], d[R + 1], d[X + 1], 0.5);
        }
        l = C - w, u = B2 - I;
      }
    ...
    Vt.findHaystackPoints = function(t) {
      ...
      if (ae && !de)
        if (W) {
          var xe = Math.abs(ie) <= c / 2, Ce = Math.abs(B2) <= v / 2;
          if (xe) {
      ...
      if (r.edgeType === "bezier") {
        ...
        if (h || c || b) {
          ...
          var w = {
            ...
            x: r.ctrlpts[0] + C.x * 2 * B2,
            y: r.ctrlpts[1] + C.y * 2 * B2
        ...
        for (var E = function(w) {
          ...
          for (var Te = 0; Te < C.eles.length; Te++) {
            ...
            if (!C.calculatedIntersection && X !== z && (C.hasBezier || C.hasUnbundled)) {
              ...
              C.nodesOverlap = !k(ke) || we.checkPoint(Oe[0], Oe[1], 0, de, se, Z.x, Z.y) || ve.checkPoint(He[0], He[1], 0, ie, oe, W.x, W.y), C.vectorNormInverse = We, B2 = {
    ...
    Qa.manualEndptToPx = function(t, e) {
      ...
      if (C === "inside-to-node")
        ...
        r = c.tgtIntn;
      else if (C === "outside-to-node" || C === "outside-to-node-or-label" ? R = B2 : (C === "outside-to-line" || C === "outside-to-line-or-label") && (R = [i.x, i.y]), r = e.nodeShapes[this.getNodeShape(n)].intersectLine(s.x, s.y, n.outerWidth(), n.outerHeight(), R[0], R[1], 0), C === "outside-to-node-or-label" || C === "outside-to-line-or-label") {
        ...
        if (ae.length > 0) {
          var xe = i, Ce = Br(xe, jr2(r)), Oe = Br(xe, jr2(ae)), Ie = Ce;
      ...
      var qe = yn(r, B2, e.arrowShapes[o].spacing(t) + u), Re = yn(r, B2, e.arrowShapes[o].gap(t) + u);
      if (c.endX = Re[0], c.endY = Re[1], c.arrowEndX = qe[0], c.arrowEndY = qe[1], w === "inside-to-node")
        ...
        if (N.length > 0) {
          var le = s, De = Br(le, jr2(r)), me = Br(le, jr2(N)), be = De;
          ...
          if (i[h]) {
            ...
            switch (a.edgeType) {
              ...
              case "multibezier": {
                ...
                var I = y.cp, C = y.segment, B2 = (d - p) / C.length, F = C.t1 - C.t0, R = v ? C.t0 + F * B2 : C.t1 - F * B2;
...
`), h = t.pstyle("text-max-width").pfValue, c = t.pstyle("text-overflow-wrap").value, v = c === "anywhere", d = [], g = /[\s\u200b]+/, y = v ? "" : " ", p = 0; p < f.length; p++) {
          ...
          if (E > h) {
            for (var A2 = m.split(g), w = "", I = 0; I < A2.length; I++) {
              var C = A2[I], B2 = w.length === 0 ? C : w + y + C, F = this.calculateLabelDimensions(t, B2), R = F.width;
...
`), p = 0; p < y.length; p++) {
          ...
          if (t.hoverData.which === 3) {
            ...
            if (It) {
              if (!t.hoverData.dragging && me.boxSelectionEnabled() && (br || !me.panningEnabled() || !me.userPanningEnabled()))
                ...
                Xr && (t.hoverData.dragging = true, t.hoverData.justStartedPan = true, dt[4] = 0, t.data.bgActivePosistion = jr2(ze), t.redrawHint("select", true), t.redraw());
              }
        ...
        if (le) {
          ...
          if (t.data.bgActivePosistion && (t.redrawHint("select", true), t.redraw()), t.hoverData.tapholdCancelled = true, t.data.bgActivePosistion = void 0, ze && ze.unactivate(), t.hoverData.which === 3) {
            ...
            !t.hoverData.isOverThresholdDrag && (r(ze, ["click", "tap", "vclick"], N, {
              x: me[0],
              y: me[1]
            }), B2 = false, N.timeStamp - F <= De.multiClickDebounceTime() ? (C && clearTimeout(C), B2 = true, F = null, r(ze, ["dblclick", "dbltap", "vdblclick"], N, {
              x: me[0],
              y: me[1]
            })) : (C = setTimeout(function() {
              B2 || r(ze, ["oneclick", "onetap", "voneclick"], N, {
                x: me[0],
                y: me[1]
              });
        ...
        if (!(!le && !I(N))) {
          ...
          if (le && t.touchData.cxt) {
            ...
            if (le && (ir == null || ir.pannable()) && me.panningEnabled() && me.userPanningEnabled()) {
              ...
              yp && (N.preventDefault(), t.data.bgActivePosistion || (t.data.bgActivePosistion = jr2(t.touchData.startPosition)), t.swipePanning ? (me.panBy({
                x: Qe[0] * Le,
                y: Qe[1] * Le
      ...
      return this.nodeShapes.barrel = {
        ...
        checkPoint: function(e, r, a, n, i, s, o) {
          ...
          for (var h = this.generateBarrelBezierPts(n, i, s, o), c = function(w, I, C) {
            var B2 = C[4], F = C[2], R = C[0], X = C[5], z = C[1], re = Math.min(B2, R), W = Math.max(B2, R), Z = Math.min(X, z), ie = Math.max(X, z);
            if (re <= w && w <= W && Z <= I && I <= ie) {
              var oe = zf(B2, F, R), de = Mf(oe[0], oe[1], oe[2], w), se = de.filter(function(ve) {
                return 0 <= ve && ve <= 1;
              });
              if (se.length > 0)
                return se[0];
    ...
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      var C = A2 && A2.level === a + 1 ? A2 : null, B2 = function() {
    ...
    Mt.makeLayer = function(t, e) {
      ...
      var l = a.layersByLevel, u = Math.pow(2, r), f = l[r] = l[r] || [], h, c = a.levelIsComplete(r, t), v, d = function() {
        var B2 = function(re) {
          ...
          if (!v)
            for (var W = r + re; en <= W && W <= Zn && !B2(W); W += re)
              ;
        };
        F(1), F(-1);
      ...
      var g = function() {
        ...
        if (F != null) {
          ...
          (B2.insert === void 0 || B2.insert) && f.unshift(X);
        return X;
      };
      if (a.skipping && !o)
        return null;
    ...
    mr.drawEdge = function(t, e, r) {
      ...
      if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
        ...
        if (A2) {
          var w = e.pstyle("ghost-offset-x").pfValue, I = e.pstyle("ghost-offset-y").pfValue, C = e.pstyle("ghost-opacity").value, B2 = g * C;
          t.translate(w, I), p(B2), E(B2), t.translate(-w, -I);
        }
    ...
    Vi.safeDrawImage = function(t, e, r, a, n, i, s, o, l, u) {
      ...
      var C = w, B2 = I;
      if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? C = f(r, "background-width", "pfValue", a) * y : C = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? B2 = f(r, "background-height", "pfValue", a) * p : B2 = f(r, "background-height", "pfValue", a)), !(C === 0 || B2 === 0)) {
        if (h === "contain") {
          var F = Math.min(y / C, p / B2);
          C *= F, B2 *= F;
        } else if (h === "cover") {
          var F = Math.max(y / C, p / B2);
          C *= F, B2 *= F;
        }
        ...
        de === "%" ? Z += (p - B2) * se : Z += se, m.pathCache && (R -= o, Z -= l, o = 0, l = 0);
        ...
        if (A2 === "no" && we ? (i.setImgSmoothing(t, false), Te = true) : A2 === "yes" && !we && (i.setImgSmoothing(t, true), Te = true), c === "no-repeat")
          E && (t.save(), m.pathCache ? t.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(r)].draw(t, o, l, y, p), t.clip())), i.safeDrawImage(t, e, 0, 0, w, I, R, Z, C, B2), E && t.restore();
        else {
        ...
        if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
          ...
          if (A2 > 0 || I > 0 && w > 0) {
            ...
            if (A2 > 0) {
              ...
              W.indexOf("round") === 0 ? jg(t, B2, F, R, X, 2) : t.fillRect(B2, F, R, X), t.fillStyle = z;
            }
            if (I > 0 && w > 0) {
              ...
              if (t.strokeRect(B2, F, R, X), de === "double") {
                var se = I / 2;
                t.strokeRect(B2 + se, F + se, R - se * 2, X - se * 2);
              }
    ...
    Ea.drawNode = function(t, e, r) {
      ...
      if (!(!k(h.x) || !k(h.y)) && !(i && !e.visible())) {
        ...
        for (var m = e.pstyle("background-image"), b = m.value, E = new Array(b.length), M = new Array(b.length), A2 = 0, w = 0; w < b.length; w++) {
          ...
          if (C) {
            var B2 = e.cy().style().getIndexedStyle(e, "background-image-crossorigin", "value", w);
            A2++, M[w] = s.getCachedImage(I, B2, function() {
        ...
        v && t.translate(-h.x, -h.y), Oe(), v && t.translate(h.x, h.y), Z(), Te(), Ee(c, true), ie(), xe(), ye(F !== 0 || R !== 0), Ee(c, false), ae(), v && t.translate(-h.x, -h.y), Ie(), Ce(), r && t.translate(p.x1, p.y1);
      }
    };
    var xu = function(e) {
      if (!["overlay", "underlay"].includes(e))
    ...
    Wt.getPixelRatio = function() {
      ...
      if (!i)
        return null;
      for (var C = l.length === o.length, B2 = o.length, F = 0; F < B2; F++)
        i.addColorStop(C ? l[F] : F / (B2 - 1), "rgba(" + o[F][0] + "," + o[F][1] + "," + o[F][2] + "," + n + ")");
      return i;
      ...
      function R(Re, Me) {
        ...
        !s.clearingMotionBlur && (Re === u.bufferContexts[s.MOTIONBLUR_BUFFER_NODE] || Re === u.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG]) ? (Ve = {
          x: M.x * v,
          y: M.y * v
        }, Fe = b * v, ke = s.canvasWidth * v, Ge = s.canvasHeight * v) : (Ve = A2, Fe = E, ke = s.canvasWidth, Ge = s.canvasHeight), Re.setTransform(1, 0, 0, 1, 0, 0), Me === "motionBlur" ? F(Re, 0, 0, ke, Ge) : !e && (Me === void 0 || Me) && Re.clearRect(0, 0, ke, Ge), r || (Re.translate(Ve.x, Ve.y), Re.scale(Fe, Fe)), i && Re.translate(i.x, i.y), n && Re.scale(n, n);
      }
      ...
      if (se[s.NODE] = !f[s.NODE] && c && !s.clearedForMotionBlur[s.NODE] || s.clearingMotionBlur, se[s.NODE] && (s.clearedForMotionBlur[s.NODE] = true), se[s.DRAG] = !f[s.DRAG] && c && !s.clearedForMotionBlur[s.DRAG] || s.clearingMotionBlur, se[s.DRAG] && (s.clearedForMotionBlur[s.DRAG] = true), f[s.NODE] || r || a || se[s.NODE]) {
        ...
        R(z, we), de ? s.drawCachedNodes(z, B2.nondrag, o, ie) : s.drawLayeredElements(z, B2.nondrag, o, ie), s.debug && s.drawDebugPoints(z, B2.nondrag), !r && !c && (f[s.NODE] = false);
      }
      if (!a && (f[s.DRAG] || r || se[s.DRAG])) {
        var ve = c && !se[s.DRAG] && v !== 1, z = e || (ve ? s.data.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG] : u.contexts[s.DRAG]);
        R(z, c && !ve ? "motionBlur" : void 0), de ? s.drawCachedNodes(z, B2.drag, o, ie) : s.drawCachedElements(z, B2.drag, o, ie), s.debug && s.drawDebugPoints(z, B2.drag), !r && !c && (f[s.DRAG] = false);
      }
    ...
    function Iu(t, e, r) {
      ...
      if (t === "core") {
        ...
        for (var i = function(I) {
          this.options = I, r.call(this, I), L2(this._private) || (this._private = {}), this._private.cy = I.cy, this._private.listeners = [], this.createEmitter();
        ...
        function(ee) {
          ...
          function(ee, ce, H) {
            ...
            V.prototype.getNodes = function() {
              ...
              if (Q instanceof G) {
                ...
                var L2 = J.source.edges.indexOf(J), $ = J.target.edges.indexOf(J);
                if (!(L2 > -1 && $ > -1))
                  throw "Source and/or target doesn't know this edge!";
                J.source.edges.splice(L2, 1), J.target != J.source && J.target.edges.splice($, 1);
              ...
              for (var Q = T.MAX_VALUE, ne = T.MAX_VALUE, ue, J, j, Y = this.getNodes(), te = Y.length, L2 = 0; L2 < te; L2++) {
                var $ = Y[L2];
              ...
              for (var ne = T.MAX_VALUE, ue = -T.MAX_VALUE, J = T.MAX_VALUE, j = -T.MAX_VALUE, Y, te, L2, $, k, q = this.nodes, he = q.length, ge = 0; ge < he; ge++) {
                var Ae = q[ge];
                Q && Ae.child != null && Ae.updateBounds(), Y = Ae.getLeft(), te = Ae.getRight(), L2 = Ae.getTop(), $ = Ae.getBottom(), ne > Y && (ne = Y), ue < te && (ue = te), J > L2 && (J = L2), j < $ && (j = $);
              }
              ...
              for (var ne = T.MAX_VALUE, ue = -T.MAX_VALUE, J = T.MAX_VALUE, j = -T.MAX_VALUE, Y, te, L2, $, k = Q.length, q = 0; q < k; q++) {
                var he = Q[q];
                Y = he.getLeft(), te = he.getRight(), L2 = he.getTop(), $ = he.getBottom(), ne > Y && (ne = Y), ue < te && (ue = te), J > L2 && (J = L2), j < $ && (j = $);
              }
          ...
          function(ee, ce, H) {
            ...
            T.calcSeparationAmount = function(x, S, G, U) {
              ...
              var V = x.getX(), _ = x.getY(), Q = x.getRight(), ne = x.getX(), ue = x.getBottom(), J = x.getRight(), j = x.getWidthHalf(), Y = x.getHeightHalf(), te = S.getX(), L2 = S.getY(), $ = S.getRight(), k = S.getX(), q = S.getBottom(), he = S.getRight(), ge = S.getWidthHalf(), Ae = S.getHeightHalf(), Ne = false, _e = false;
              if (U === K) {
                if (P > D)
                  return G[0] = U, G[1] = _, G[2] = K, G[3] = q, false;
                if (P < D)
                  return G[0] = U, G[1] = ue, G[2] = K, G[3] = L2, false;
              } else if (P === D) {
                if (U > K)
                ...
                if (-tt === Pe ? U > K ? (G[0] = ne, G[1] = ue, Ne = true) : (G[0] = Q, G[1] = _, Ne = true) : tt === Pe && (U > K ? (G[0] = V, G[1] = _, Ne = true) : (G[0] = J, G[1] = ue, Ne = true)), -ct === Pe ? K > U ? (G[2] = k, G[3] = q, _e = true) : (G[2] = $, G[3] = L2, _e = true) : ct === Pe && (K > U ? (G[2] = te, G[3] = L2, _e = true) : (G[2] = he, G[3] = q, _e = true)), Ne && _e)
                  return false;
                ...
                if (!_e)
                  switch (Xe) {
                    case 1:
                      je = L2, nt = K + -Ae / Pe, G[2] = nt, G[3] = je;
                      break;
                    case 2:
              ...
              var P = x.x, K = x.y, D = S.x, V = S.y, _ = G.x, Q = G.y, ne = U.x, ue = U.y, J = void 0, j = void 0, Y = void 0, te = void 0, L2 = void 0, $ = void 0, k = void 0, q = void 0, he = void 0;
              return Y = V - K, L2 = P - D, k = D * K - P * V, te = ue - Q, $ = _ - ne, q = ne * Q - _ * ue, he = Y * $ - te * L2, he === 0 ? null : (J = (L2 * q - $ * k) / he, j = (te * k - Y * q) / he, new O(J, j));
          ...
          function(ee, ce, H) {
            ...
            V.RANDOM_SEED = 1, V.prototype = Object.create(D.prototype), V.prototype.getGraphManager = function() {
              ...
              if (!ue)
                return _;
              var j = /* @__PURE__ */ new Set(), Y = [], te = /* @__PURE__ */ new Map(), L2 = [];
              for (L2 = L2.concat(ne); L2.length > 0 && Q; ) {
                for (Y.push(L2[0]); Y.length > 0 && Q; ) {
                  var $ = Y[0];
                  Y.splice(0, 1), j.add($);
              ...
              if (ne != null && ue != null) {
                ...
                var te, L2;
                return _ <= 50 ? (te = 9 * Q / 500, L2 = Q / 10) : (te = 9 * Q / 50, L2 = -8 * Q), te * _ + L2;
              }
              ...
              for (var Y = 0; Y < Q.length; Y++) {
                var te = Q[Y], L2 = te.getNeighborsList().size;
                ue.set(te, te.getNeighborsList().size), L2 == 1 && ne.push(te);
              }
              var $ = [];
              for ($ = $.concat(ne); !J; ) {
                var k = [];
          ...
          function(ee, ce, H) {
            ...
            P.prototype.initParameters = function() {
              ...
              var _ = D.getRect(), Q = V.getRect(), ne = new Array(2), ue = new Array(4), J, j, Y, te, L2, $, k;
              if (_.intersects(Q)) {
                    ...
                    if (!(j < 0 || Y < 0 || j >= J.length || Y >= J[0].length)) {
                      for (var te = 0; te < J[j][Y].length; te++)
                        if (ue = J[j][Y][te], !(D.getOwner() != ue.getOwner() || D == ue) && !V.has(ue) && !ne.has(ue)) {
                          var L2 = Math.abs(D.getCenterX() - ue.getCenterX()) - (D.getWidth() / 2 + ue.getWidth() / 2), $ = Math.abs(D.getCenterY() - ue.getCenterY()) - (D.getHeight() / 2 + ue.getHeight() / 2);
                          L2 <= this.repulsionRange && $ <= this.repulsionRange && ne.add(ue);
                        }
                    }
        ...
        function(ce) {
          ...
          function(ce, H, O) {
            ...
            Y.prototype.newGraphManager = function() {
              var L2 = new x(this);
              return this.graphManager = L2, L2;
            }, Y.prototype.newGraph = function(L2) {
              return new S(null, this.graphManager, L2);
            }, Y.prototype.newNode = function(L2) {
              return new G(this.graphManager, L2);
            }, Y.prototype.newEdge = function(L2) {
              return new U(null, null, L2);
              ...
              var L2 = D.DEFAULT_CREATE_BENDS_AS_NEEDED;
              return L2 && (this.createBendpoints(), this.graphManager.resetAllEdges()), this.level = 0, this.classicLayout();
              ...
              if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
                ...
                var L2 = this.getFlatForest();
                if (L2.length > 0)
                  this.positionNodesRadially(L2);
                else {
                  this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
              ...
              if (this.isTreeGrowing) {
                if (this.growTreeIterations % 10 == 0)
                  if (this.prunedNodesAll.length > 0) {
                    ...
                    var L2 = new Set(this.getAllNodes()), $ = this.nodesWithGravity.filter(function(he) {
                      return L2.has(he);
                    });
              ...
              for (var L2 = this.graphManager.getAllNodes(), $ = {}, k = 0; k < L2.length; k++) {
                var q = L2[k].rect, he = L2[k].id;
                $[he] = {
                  id: he,
                  x: q.getCenterX(),
                  y: q.getCenterY(),
              ...
              var L2 = [], $, k = this.graphManager.getGraphs(), q = k.length, he;
              for (he = 0; he < q; he++)
                $ = k[he], $.updateConnected(), $.isConnected || (L2 = L2.concat($.getNodes()));
              return L2;
            }, Y.prototype.createBendpoints = function() {
              var L2 = [];
              L2 = L2.concat(this.graphManager.getAllEdges());
            ...
            }, Y.prototype.positionNodesRadially = function(L2) {
              for (var $ = new V(0, 0), k = Math.ceil(Math.sqrt(L2.length)), q = 0, he = 0, ge = 0, Ae = new _(0, 0), Ne = 0; Ne < L2.length; Ne++) {
                Ne % k == 0 && (ge = 0, he = q, Ne != 0 && (he += P.DEFAULT_COMPONENT_SEPERATION), q = 0);
                var _e = L2[Ne], tt = Q.findCenterOfTree(_e);
            ...
            }, Y.radialLayout = function(L2, $, k) {
              var q = Math.max(this.maxDiagonalInTree(L2), P.DEFAULT_RADIAL_SEPARATION);
              Y.branchRadialLayout($, null, 0, 359, 0, q);
              var he = J.calculateBounds(L2), ge = new j();
              ge.setDeviceOrgX(he.getMinX()), ge.setDeviceOrgY(he.getMinY()), ge.setWorldOrgX(k.x), ge.setWorldOrgY(k.y);
              for (var Ae = 0; Ae < L2.length; Ae++) {
                var Ne = L2[Ae];
                Ne.transform(ge);
              }
              var _e = new _(he.getMaxX(), he.getMaxY());
              return ge.inverseTransformPoint(_e);
            }, Y.branchRadialLayout = function(L2, $, k, q, he, ge) {
              var Ae = (q - k + 1) / 2;
              Ae < 0 && (Ae += 180);
              var Ne = (Ae + k) % 360, _e = Ne * ue.TWO_PI / 360, tt = he * Math.cos(_e), ct = he * Math.sin(_e);
              L2.setCenter(tt, ct);
              var Pe = [];
              Pe = Pe.concat(L2.getEdges());
              var $e = Pe.length;
              $ != null && $e--;
              for (var Xe = 0, rt = Pe.length, lt, nt = L2.getEdgesBetween($); nt.length > 1; ) {
                var je = nt[0];
                nt.splice(0, 1);
              ...
              for (var Et = Math.abs(q - k) / $e, kt = lt; Xe != $e; kt = ++kt % rt) {
                var vt = Pe[kt].getOtherEnd(L2);
                if (vt != $) {
                  var vr = (k + Xe * Et) % 360, qt = (vr + Et) % 360;
                  Y.branchRadialLayout(vt, L2, vr, qt, he + ge, ge), Xe++;
                }
              }
            }, Y.maxDiagonalInTree = function(L2) {
              for (var $ = ne.MIN_VALUE, k = 0; k < L2.length; k++) {
                var q = L2[k], he = q.getDiagonal();
                he > $ && ($ = he);
              }
              return $;
              ...
              Object.keys($).forEach(function(_e) {
                if ($[_e].length > 1) {
                  ...
                  L2.memberGroups[tt] = $[_e];
                  var ct = $[_e][0].getParent(), Pe = new G(L2.graphManager);
                  Pe.id = tt, Pe.paddingLeft = ct.paddingLeft || 0, Pe.paddingRight = ct.paddingRight || 0, Pe.paddingBottom = ct.paddingBottom || 0, Pe.paddingTop = ct.paddingTop || 0, L2.idToDummyNode[tt] = Pe;
                  var $e = L2.getGraphManager().add(L2.newGraph(), Pe), Xe = ct.getChild();
                  Xe.add(Pe);
              ...
              for (var k = 0; k < this.compoundOrder.length; k++)
                $[this.compoundOrder[k].id] = this.compoundOrder[k], L2[this.compoundOrder[k].id] = [].concat(this.compoundOrder[k].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[k].getChild()), this.compoundOrder[k].child = null;
              this.graphManager.resetAllNodes(), this.tileCompoundMembers(L2, $);
            }, Y.prototype.clearZeroDegreeMembers = function() {
              var L2 = this, $ = this.tiledZeroDegreePack = [];
              Object.keys(this.memberGroups).forEach(function(k) {
                var q = L2.idToDummyNode[k];
                $[k] = L2.tileNodes(L2.memberGroups[k], q.paddingLeft + q.paddingRight), q.rect.width = $[k].width, q.rect.height = $[k].height;
              });
            }, Y.prototype.repopulateCompounds = function() {
              for (var L2 = this.compoundOrder.length - 1; L2 >= 0; L2--) {
                var $ = this.compoundOrder[L2], k = $.id, q = $.paddingLeft, he = $.paddingTop;
              ...
              Object.keys($).forEach(function(k) {
                var q = L2.idToDummyNode[k], he = q.paddingLeft, ge = q.paddingTop;
                L2.adjustLocations($[k], q.rect.x, q.rect.y, he, ge);
              });
            }, Y.prototype.getToBeTiled = function(L2) {
              var $ = L2.id;
            ...
            }, Y.prototype.getNodeDegree = function(L2) {
              L2.id;
              for (var $ = L2.getEdges(), k = 0, q = 0; q < $.length; q++) {
                var he = $[q];
                he.getSource().id !== he.getTarget().id && (k = k + 1);
              }
              return k;
            }, Y.prototype.getNodeDegreeWithChildren = function(L2) {
              var $ = this.getNodeDegree(L2);
              if (L2.getChild() == null)
                return $;
              for (var k = L2.getChild().getNodes(), q = 0; q < k.length; q++) {
                var he = k[q];
            ...
            }, Y.prototype.fillCompexOrderByDFS = function(L2) {
              for (var $ = 0; $ < L2.length; $++) {
                var k = L2[$];
                k.getChild() != null && this.fillCompexOrderByDFS(k.getChild().getNodes()), this.getToBeTiled(k) && this.compoundOrder.push(k);
              }
            }, Y.prototype.adjustLocations = function(L2, $, k, q, he) {
              $ += q, k += he;
              for (var ge = $, Ae = 0; Ae < L2.rows.length; Ae++) {
                var Ne = L2.rows[Ae];
                $ = ge;
                for (var _e = 0, tt = 0; tt < Ne.length; tt++) {
                  var ct = Ne[tt];
                  ct.rect.x = $, ct.rect.y = k, $ += ct.rect.width + L2.horizontalPadding, ct.rect.height > _e && (_e = ct.rect.height);
                }
                k += _e + L2.verticalPadding;
              }
            }, Y.prototype.tileCompoundMembers = function(L2, $) {
              var k = this;
              this.tiledMemberPack = [], Object.keys(L2).forEach(function(q) {
                var he = $[q];
                k.tiledMemberPack[q] = k.tileNodes(L2[q], he.paddingLeft + he.paddingRight), he.rect.width = k.tiledMemberPack[q].width, he.rect.height = k.tiledMemberPack[q].height;
              });
            }, Y.prototype.tileNodes = function(L2, $) {
              ...
              return he;
            }, Y.prototype.insertNodeToRow = function(L2, $, k, q) {
              var he = q;
              if (k == L2.rows.length) {
                var ge = [];
                L2.rows.push(ge), L2.rowWidth.push(he), L2.rowHeight.push(0);
              }
              var Ae = L2.rowWidth[k] + $.rect.width;
              L2.rows[k].length > 0 && (Ae += L2.horizontalPadding), L2.rowWidth[k] = Ae, L2.width < Ae && (L2.width = Ae);
              var Ne = $.rect.height;
              k > 0 && (Ne += L2.verticalPadding);
              var _e = 0;
              Ne > L2.rowHeight[k] && (_e = L2.rowHeight[k], L2.rowHeight[k] = Ne, _e = L2.rowHeight[k] - _e), L2.height += _e, L2.rows[k].push($);
            }, Y.prototype.getShortestRowIndex = function(L2) {
              for (var $ = -1, k = Number.MAX_VALUE, q = 0; q < L2.rows.length; q++)
                L2.rowWidth[q] < k && ($ = q, k = L2.rowWidth[q]);
              return $;
            }, Y.prototype.getLongestRowIndex = function(L2) {
              for (var $ = -1, k = Number.MIN_VALUE, q = 0; q < L2.rows.length; q++)
                L2.rowWidth[q] > k && ($ = q, k = L2.rowWidth[q]);
              return $;
            }, Y.prototype.canAddHorizontal = function(L2, $, k) {
              var q = this.getShortestRowIndex(L2);
              if (q < 0)
                return true;
              var he = L2.rowWidth[q];
              if (he + L2.horizontalPadding + $ <= L2.width)
                return true;
              var ge = 0;
              L2.rowHeight[q] < k && q > 0 && (ge = k + L2.verticalPadding - L2.rowHeight[q]);
              var Ae;
              L2.width - he >= $ + L2.horizontalPadding ? Ae = (L2.height + ge) / (he + $ + L2.horizontalPadding) : Ae = (L2.height + ge) / L2.width, ge = k + L2.verticalPadding;
              var Ne;
              return L2.width < $ ? Ne = (L2.height + ge) / $ : Ne = (L2.height + ge) / L2.width, Ne < 1 && (Ne = 1 / Ne), Ae < 1 && (Ae = 1 / Ae), Ae < Ne;
            }, Y.prototype.shiftToLastRow = function(L2) {
              var $ = this.getLongestRowIndex(L2), k = L2.rowWidth.length - 1, q = L2.rows[$], he = q[q.length - 1], ge = he.width + L2.horizontalPadding;
              if (L2.width - L2.rowWidth[k] > ge && $ != k) {
                q.splice(-1, 1), L2.rows[k].push(he), L2.rowWidth[$] = L2.rowWidth[$] - ge, L2.rowWidth[k] = L2.rowWidth[k] + ge, L2.width = L2.rowWidth[instance.getLongestRowIndex(L2)];
                for (var Ae = Number.MIN_VALUE, Ne = 0; Ne < q.length; Ne++)
                  q[Ne].height > Ae && (Ae = q[Ne].height);
                $ > 0 && (Ae += L2.verticalPadding);
                var _e = L2.rowHeight[$] + L2.rowHeight[k];
                L2.rowHeight[$] = Ae, L2.rowHeight[k] < he.height + L2.verticalPadding && (L2.rowHeight[k] = he.height + L2.verticalPadding);
                var tt = L2.rowHeight[$] + L2.rowHeight[k];
                L2.height += tt - _e, this.shiftToLastRow(L2);
              }
              ...
              for (var L2 = [], $ = true, k; $; ) {
                ...
                if ($ == true) {
                  ...
                  L2.push(Ae), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
                }
              }
              this.prunedNodesAll = L2;
            }, Y.prototype.growTree = function(L2) {
              for (var $ = L2.length, k = L2[$ - 1], q, he = 0; he < k.length; he++)
                q = k[he], this.findPlaceforPrunedNode(q), q[2].add(q[0]), q[2].add(q[1], q[1].source, q[1].target);
              L2.splice(L2.length - 1, 1), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
            }, Y.prototype.findPlaceforPrunedNode = function(L2) {
              var $, k, q = L2[0];
              q == L2[1].source ? k = L2[1].target : k = L2[1].source;
        ...
        function(ce, H, O) {
          ...
          _.prototype.run = function() {
            ...
            for (var J = {}, j = 0; j < ue.length; j++)
              J[ue[j].id()] = true;
            var Y = ue.filter(function(te, L2) {
              typeof te == "number" && (te = L2);
            ...
            for (var Y = J.length, te = 0; te < Y; te++) {
              var L2 = J[te], $ = L2.children(), k, q = L2.layoutDimensions({
                nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
              });
              if (L2.outerWidth() != null && L2.outerHeight() != null ? k = ue.add(new U(j.graphManager, new P(L2.position("x") - q.w / 2, L2.position("y") - q.h / 2), new K(parseFloat(q.w), parseFloat(q.h)))) : k = ue.add(new U(this.graphManager)), k.id = L2.data("id"), k.paddingLeft = parseInt(L2.css("padding")), k.paddingTop = parseInt(L2.css("padding")), k.paddingRight = parseInt(L2.css("padding")), k.paddingBottom = parseInt(L2.css("padding")), this.options.nodeDimensionsIncludeLabels && L2.isParent()) {
                var he = L2.boundingBox({ includeLabels: true, includeNodes: false }).w, ge = L2.boundingBox({ includeLabels: true, includeNodes: false }).h, Ae = L2.css("text-halign");
                k.labelWidth = he, k.labelHeight = ge, k.labelPos = Ae;
              }
              if (this.idToLNode[L2.data("id")] = k, isNaN(k.rect.x) && (k.rect.x = 0), isNaN(k.rect.y) && (k.rect.y = 0), $ != null && $.length > 0) {
                var Ne;
...
function Qp(pe, fe) {
  fe.edges().map((ee, ce) => {
    ...
    if (ee[0]._private.bodyBounds) {
      ...
      L.trace("Edge: ", ce, H), pe.insert("path").attr(
        "d",
...
function jp(pe) {
  pe.nodes().map((fe, ee) => {
    ...
    L.info("Id:", ee, "Position: (", fe.position().x, ", ", fe.position().y, ")", ce), H.attr(
      "transform",
...
var ey = async (pe, fe, ee, ce) => {
  const H = Ft();
  H.htmlLabels = false, L.debug(`Rendering mindmap diagram
` + pe, ce.parser);
  ...
  Qp(U, K), jp(K), py(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
};
var ty = {
  draw: ey
};
var ry = (pe) => {
  ...
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++)
    pe["lineColor" + ee] = pe["lineColor" + ee] || pe["cScaleInv" + ee], ci(pe["lineColor" + ee]) ? pe["lineColor" + ee] = B(pe["lineColor" + ee], 20) : pe["lineColor" + ee] = A(pe["lineColor" + ee], 20);
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++) {
    const ce = "" + (17 - 3 * ee);
    fe += `
...
mermaid/dist/mindmap-definition-5c6cc2b2.js:
  (*!
...
*/
//# sourceMappingURL=mindmap-definition-5c6cc2b2-36WH6Z7Q.js.map
