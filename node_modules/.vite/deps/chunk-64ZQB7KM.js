...
// node_modules/mermaid/dist/edges-020bfa8c.js
var ct = (a, t, r, n) => {
  t.forEach((e) => {
    bt[e](a, r, n);
  });
...
var kt = (a, t, r, n) => {
  let e = a || "";
  if (typeof e == "object" && (e = e[0]), Ta(Ft().flowchart.htmlLabels)) {
    e = e.replace(/\\n|\n/g, "<br />"), L.info("vertexText" + e);
    const i = {
      isNode: n,
      label: $b(e).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
var B = async (a, t, r, n) => {
  let e;
  const i = t.useHtmlLabels || Ta(Ft().flowchart.htmlLabels);
  ...
  const o = l.node();
  let h;
  t.labelType === "markdown" ? h = jr(l, ei($b(c), Ft()), {
    useHtmlLabels: i,
          ...
          (y) => new Promise((x) => {
            function M() {
              if (y.style.display = "flex", y.style.flexDirection = "column", g) {
                const C = Ft().fontSize ? Ft().fontSize : window.getComputedStyle(document.body).fontSize, X = 5;
...
var Bt = async (a, t) => {
  ...
  return s.attr("rx", t.rx).attr("ry", t.ry).attr("x", -e.width / 2 - i).attr("y", -e.height / 2 - i).attr("width", e.width + t.padding).attr("height", e.height + t.padding), S2(t, s), t.intersect = function(l) {
    return m.rect(t, l);
  }, n;
};
var Ct2 = Bt;
...
var G = async (a, t) => {
  ...
  const c = $(r, s, s, l);
  return c.attr("style", t.style), S2(t, c), t.intersect = function(o) {
    return L.warn("Intersect called"), m.polygon(t, l, o);
  }, r;
};
var Tt = (a, t) => {
...
var Rt = async (a, t) => {
  ...
  return o.attr("style", t.style), S2(t, o), t.intersect = function(h) {
...
var Ht = async (a, t) => {
  ...
  return l.attr("style", t.style), S2(t, l), t.intersect = function(c) {
    return m.polygon(t, s, c);
  }, r;
};
var Nt = async (a, t) => {
...
var Yt = async (a, t) => {
  ...
  return S2(t, o), t.intersect = function(h) {
...
var Wt = async (a, t) => {
  ...
  return S2(t, i), t.intersect = function(c) {
    return m.rect(t, c);
  }, r;
};
var jt = async (a, t) => {
  ...
  return S2(t, n), t.intersect = function(s) {
    return m.rect(t, s);
  }, r;
};
function st(a, t, r, n) {
  ...
  t.includes("t") ? (L.debug("add top border"), i(r)) : s(r), t.includes("r") ? (L.debug("add right border"), i(n)) : s(n), t.includes("b") ? (L.debug("add bottom border"), i(r)) : s(r), t.includes("l") ? (L.debug("add left border"), i(n)) : s(n), a.attr("stroke-dasharray", e.join(" "));
}
var Dt = (a, t) => {
  let r;
  ...
  ), e.attr("class", "outer title-state").attr("x", -h.width / 2 - b).attr("y", -h.height / 2 - b).attr("width", h.width + t.padding).attr("height", h.height + t.padding), i.attr("class", "divider").attr("x1", -h.width / 2 - b).attr("x2", h.width / 2 + b).attr("y1", -h.height / 2 - b + d.height + b).attr("y2", -h.height / 2 - b + d.height + b), S2(t, e), t.intersect = function(k) {
    return m.rect(t, k);
  }, n;
};
var At = async (a, t) => {
  ...
  return S2(t, s), t.intersect = function(l) {
    return m.rect(t, l);
  }, r;
};
var Ut = async (a, t) => {
  ...
  return i.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + e).attr("width", n.width + t.padding).attr("height", n.height + t.padding), L.info("Circle main"), S2(t, i), t.intersect = function(s) {
    return L.info("Circle intersect", t, n.width / 2 + e, s), m.circle(t, n.width / 2 + e, s);
  }, r;
};
var zt = async (a, t) => {
  const { shapeSvg: r, bbox: n, halfPadding: e } = await B(
...
var Ft2 = (a, t) => {
  ...
  return n.attr("class", "state-start").attr("r", 7).attr("width", 14).attr("height", 14), S2(t, n), t.intersect = function(e) {
...
var P = (a, t, r) => {
  ...
  return S2(t, s), t.height = t.height + t.padding / 2, t.width = t.width + t.padding / 2, t.intersect = function(l) {
    return m.rect(t, l);
  }, n;
};
var Qt = (a, t) => {
  ...
  return e.attr("class", "state-start").attr("r", 7).attr("width", 14).attr("height", 14), n.attr("class", "state-end").attr("r", 5).attr("width", 10).attr("height", 10), S2(t, e), t.intersect = function(i) {
...
var Vt = (a, t) => {
  ...
  let y = g.getBBox();
  if (Ta(Ft().flowchart.htmlLabels)) {
    const L2 = g.children[0], v = Ct(g);
    y = L2.getBoundingClientRect(), v.attr("width", y.width), v.attr("height", y.height);
  }
  t.classData.annotations[0] && (f += y.height + n, h += y.width);
  let x = t.classData.label;
  t.classData.type !== void 0 && t.classData.type !== "" && (Ft().flowchart.htmlLabels ? x += "&lt;" + t.classData.type + "&gt;" : x += "<" + t.classData.type + ">");
  const M = d.node().appendChild(I(x, t.labelStyle, true, true));
  Ct(M).attr("class", "classTitle");
  let C = M.getBBox();
  if (Ta(Ft().flowchart.htmlLabels)) {
    const L2 = M.children[0], v = Ct(M);
    C = L2.getBoundingClientRect(), v.attr("width", C.width), v.attr("height", C.height);
  }
  f += C.height + n, C.width > h && (h = C.width);
  const X = [];
  t.classData.members.forEach((L2) => {
    const v = L2.getDisplayDetails();
    let Y = v.displayText;
    Ft().flowchart.htmlLabels && (Y = Y.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
  ...
  const V = [];
  if (t.classData.methods.forEach((L2) => {
    const v = L2.getDisplayDetails();
    let Y = v.displayText;
    Ft().flowchart.htmlLabels && (Y = Y.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
    const N = d.node().appendChild(
  ...
  return Ct(M).attr(
  ...
  ), p += C.height + n, c.attr("class", "divider").attr("x1", -h / 2 - r).attr("x2", h / 2 + r).attr("y1", -f / 2 - r + e + p).attr("y2", -f / 2 - r + e + p), p += e, X.forEach((L2) => {
    Ct(L2).attr(
      "transform",
      "translate( " + -h / 2 + ", " + (-1 * f / 2 + p + e / 2) + ")"
    );
    const v = L2 == null ? void 0 : L2.getBBox();
    p += ((v == null ? void 0 : v.height) ?? 0) + n;
  }), p += e, o.attr("class", "divider").attr("x1", -h / 2 - r).attr("x2", h / 2 + r).attr("y1", -f / 2 - r + e + p).attr("y2", -f / 2 - r + e + p), p += e, V.forEach((L2) => {
    Ct(L2).attr(
      "transform",
    ...
    const v = L2 == null ? void 0 : L2.getBBox();
    p += ((v == null ? void 0 : v.height) ?? 0) + n;
  }), l.attr("class", "outer title-state").attr("x", -h / 2 - r).attr("y", -(f / 2) - r).attr("width", h + t.padding).attr("height", f + t.padding), S2(t, l), t.intersect = function(L2) {
    return m.rect(t, L2);
  }, s;
};
var tt = {
...
var ar = async (a, t, r) => {
  ...
  if (t.link) {
    let i;
    Ft().securityLevel === "sandbox" ? i = "_top" : t.linkTarget && (i = t.linkTarget || "_blank"), n = a.insert("svg:a").attr("xlink:href", t.link).attr("target", i), e = await tt[t.shape](n, t, r);
  } else
...
var lr = (a, t) => {
  const r = Ta(Ft().flowchart.htmlLabels), n = t.labelType === "markdown" ? jr(a, t.label, {
    style: t.labelStyle,
    useHtmlLabels: r,
    addSvgBackground: true
  }) : I(t.label, t.labelStyle);
  L.info("abc82", t, t.labelType);
...
function U(a, t) {
  Ft().flowchart.htmlLabels && a && (a.style.width = t.length * 9 + "px", a.style.height = "12px");
}
var cr = (a, t) => {
  L.info("Moving label abc78 ", a.id, a.label, Z[a.id]);
  let r = t.updatedPath ? t.updatedPath : t.originalPath;
  if (a.label) {
    const n = Z[a.id];
    let e = a.x, i = a.y;
    if (r) {
      const s = Xe.calcLabelPosition(r);
      L.info(
  ...
  if (a.startLabelLeft) {
    ...
    let e = a.x, i = a.y;
    if (r) {
      const s = Xe.calcTerminalLabelPosition(a.arrowTypeStart ? 10 : 0, "start_left", r);
      e = s.x, i = s.y;
    }
    n.attr("transform", "translate(" + e + ", " + i + ")");
  }
  if (a.startLabelRight) {
    ...
    let e = a.x, i = a.y;
    if (r) {
      const s = Xe.calcTerminalLabelPosition(
  ...
  if (a.endLabelLeft) {
    ...
    let e = a.x, i = a.y;
    if (r) {
      const s = Xe.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_left", r);
      e = s.x, i = s.y;
    }
    n.attr("transform", "translate(" + e + ", " + i + ")");
  }
  if (a.endLabelRight) {
    ...
    let e = a.x, i = a.y;
    if (r) {
      const s = Xe.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_right", r);
      e = s.x, i = s.y;
    }
    n.attr("transform", "translate(" + e + ", " + i + ")");
  }
...
var Kt = (a, t, r) => {
  ...
  if (Math.abs(e - t.y) * s > Math.abs(n - t.x) * c) {
    ...
    return l === 0 && (d.x = t.x, d.y = t.y), h === 0 && (d.x = t.x), o === 0 && (d.y = t.y), L.warn(`abc89 topp/bott calc, Q ${o}, q ${f}, R ${h}, r ${l}`, d), d;
  } else {
    r.x < t.x ? l = t.x - s - n : l = n - s - t.x;
    let f = o * l / h, d = r.x < t.x ? r.x + h - l : r.x - h + l, p = r.y < t.y ? r.y + f : r.y - f;
    return L.warn(`sides calc abc89, Q ${o}, q ${f}, R ${h}, r ${l}`, { _x: d, _y: p }), l === 0 && (d = t.x, p = t.y), h === 0 && (d = t.x), o === 0 && (p = t.y), { x: d, y: p };
  }
};
var rt = (a, t) => {
  L.warn("abc88 cutPathAtIntersect", a, t);
  let r = [], n = a[0], e = false;
  return a.forEach((i) => {
    if (L.info("abc88 checking point", i, t), !qt(t, i) && !e) {
      const s = Kt(t, n, i);
      L.warn("abc88 inside", i, n, s), L.warn("abc88 intersection", s);
      let l = false;
      r.forEach((c) => {
        l = l || c.x === s.x && c.y === s.y;
      }), r.some((c) => c.x === s.x && c.y === s.y) ? L.warn("abc88 no intersect", s, r) : r.push(s), e = true;
    } else
      L.warn("abc88 outside", i, n), n = i, e || r.push(i);
  }), L.warn("abc88 returning points", r), r;
};
var hr = function(a, t, r, n, e, i, s) {
  let l = r.points, c = false;
  const o = i.node(t.v);
  var h = i.node(t.w);
  L.info("abc88 InsertEdge: ", r), h.intersect && o.intersect && (l = l.slice(1, r.points.length - 1), l.unshift(o.intersect(l[0])), L.info(
    "Last point",
    l[l.length - 1],
    h,
    h.intersect(l[l.length - 1])
  ), l.push(h.intersect(l[l.length - 1]))), r.toCluster && (L.info("to cluster abc88", n[r.toCluster]), l = rt(r.points, n[r.toCluster].node), c = true), r.fromCluster && (L.info("from cluster abc88", n[r.fromCluster]), l = rt(l.reverse(), n[r.fromCluster].node).reverse(), c = true);
  const f = l.filter((C) => !Number.isNaN(C.y));
  let d = Nf;
  r.curve && (e === "graph" || e === "flowchart") && (d = r.curve);
  const { x: p, y: b } = Jt(r), k = S().x(p).y(b).curve(d);
  let g;
  switch (r.thickness) {
    case "normal":
  ...
  let x = "";
  switch ((Ft().flowchart.arrowMarkerAbsolute || Ft().state.arrowMarkerAbsolute) && (x = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, x = x.replace(/\(/g, "\\("), x = x.replace(/\)/g, "\\)")), L.info("arrowTypeStart", r.arrowTypeStart), L.info("arrowTypeEnd", r.arrowTypeEnd), r.arrowTypeStart) {
    case "arrow_cross":
      y.attr(
        "marker-start",
...
//# sourceMappingURL=chunk-64ZQB7KM.js.map
