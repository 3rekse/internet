...
// node_modules/mermaid/dist/infoDiagram-121d662e.js
var O = function() {
  var a = function(u, t, e, n) {
    ...
    parse: function(t) {
      var e = this, n = [0], s = [], r = [null], i = [], d = this.table, $ = "", v = 0, L2 = 0, N = 2, T = 1, R = i.slice.call(arguments, 1), o = Object.create(this.lexer), p = { yy: {} };
...
Expecting ` + S.join(", ") + ", got '" + (this.terminals_[l] || l) + "'" : A = "Parse error on line " + (v + 1) + ": Unexpected " + (l == T ? "end of input" : "'" + (this.terminals_[l] || l) + "'"), this.parseError(A, {
        ...
        switch (h[0]) {
          case 1:
            n.push(l), r.push(o.yytext), i.push(o.yylloc), n.push(h[1]), l = null, L2 = o.yyleng, $ = o.yytext, v = o.yylineno, I = o.yylloc;
            break;
          case 2:
...
` + a);
  const k = uy(f);
  Sl(k, 100, 400, true), k.append("g").append("text").attr("x", 100).attr("y", 40).attr("class", "version").attr("font-size", 32).style("text-anchor", "middle").text(`v${m}`);
};
var H = { draw: G };
var K = {
  parser: V,
...
//# sourceMappingURL=infoDiagram-121d662e-67RZ4P46.js.map
