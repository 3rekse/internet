...
// node_modules/mermaid/dist/erDiagram-5298a456.js
var at = function() {
  var t = function(w, a, n, c) {
    ...
    parse: function(a) {
      ...
      for (var S2, G, D, tt, H = {}, j, P, lt, q; ; ) {
        if (G = c[c.length - 1], this.defaultActions[G] ? D = this.defaultActions[G] : ((S2 === null || typeof S2 > "u") && (S2 = _t()), D = K[G] && K[G][S2]), typeof D > "u" || !D.length || !D[0]) {
          var et = "";
          q = [];
          for (j in K[G])
...
` + b.showPosition() + `
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[S2] || S2) + "'" : et = "Parse error on line " + (Q + 1) + ": Unexpected " + (S2 == ot ? "end of input" : "'" + (this.terminals_[S2] || S2) + "'"), this.parseError(et, {
            text: b.match,
        ...
        if (D[0] instanceof Array && D.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + G + ", token: " + S2);
        switch (D[0]) {
          case 1:
            c.push(S2), E.push(b.yytext), i.push(b.yylloc), c.push(D[1]), S2 = null, st = b.yyleng, s = b.yytext, Q = b.yylineno, $ = b.yylloc;
            break;
          case 2:
...
` + this.showPosition(), {
  ...
  return L3.prototype = R, R.Parser = L3, new L3();
}();
at.parser = at;
var It = at;
var U = {};
...
var dt = function(t, e = void 0) {
  return U[t] === void 0 ? (U[t] = { attributes: [], alias: e }, L2.info("Added new entity :", t)) : U[t] && !U[t].alias && e && (U[t].alias = e, L2.info(`Add alias '${e}' to entity '${t}'`)), U[t];
};
var vt = () => U;
var Bt = function(t, e) {
  let r = dt(t), u;
  for (u = e.length - 1; u >= 0; u--)
    r.attributes.push(e[u]), L2.debug("Added attribute ", e[u].attributeName);
};
var Ct2 = function(t, e, r, u) {
  ...
  nt.push(l), L2.debug("Added new relationship :", l);
};
var Pt = () => nt;
var Yt = function() {
  U = {}, nt = [], Ry();
...
var ee = (t, e, r) => {
  ...
  r.forEach((T) => {
    ...
    let R = 0;
    const O = l1(T.attributeType), L3 = t.append("text").classed("er entityLabel", true).attr("id", `${M}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Ft().fontFamily).style("font-size", p + "px").text(O), w = t.append("text").classed("er entityLabel", true).attr("id", `${M}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Ft().fontFamily).style("font-size", p + "px").text(T.attributeName), a = {};
    a.tn = L3, a.nn = w;
    const n = L3.node().getBBox(), c = w.node().getBBox();
    if (m = Math.max(m, n.width), g = Math.max(g, c.width), R = Math.max(n.height, c.height), h) {
      const d = T.attributeKeyTypeList !== void 0 ? T.attributeKeyTypeList.join(",") : "", E = t.append("text").classed("er entityLabel", true).attr("id", `${M}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Ft().fontFamily).style("font-size", p + "px").text(d);
      a.kn = E;
      const i = E.node().getBBox();
      x = Math.max(x, i.width), R = Math.max(R, i.height);
    }
    if (_) {
      const d = t.append("text").classed("er entityLabel", true).attr("id", `${M}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Ft().fontFamily).style("font-size", p + "px").text(T.attributeComment || "");
      a.cn = d;
  ...
  if (r.length > 0) {
    ...
    o.forEach((O) => {
      const L3 = M + u + O.height / 2;
      O.tn.attr("transform", "translate(" + l + "," + L3 + ")");
...
var re = function(t, e, r) {
  ...
  return u.forEach(function(p) {
    ...
    l = l === void 0 ? f : l;
    const h = "text-" + f, _ = o.append("text").classed("er entityLabel", true).attr("id", h).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", Ft().fontFamily).style("font-size", k.fontSize + "px").text(e[p].alias ?? p), { width: m, height: g } = ee(
      o,
      _,
      e[p].attributes
...
var ne = function(t, e, r, u, l) {
  ...
  const p = r.edge(
    ...
    return N.y;
  }).curve(Nf), o = t.insert("path", "#" + u).classed("er relationshipLine", true).attr("d", f(p.points)).style("stroke", k.stroke).style("fill", "none");
  ...
  const _ = o.node().getTotalLength(), m = o.node().getPointAtLength(_ * 0.5), g = "rel" + ct, y = t.append("text").classed("er relationshipLabel", true).attr("id", g).attr("x", m.x).attr("y", m.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", Ft().fontFamily).style("font-size", k.fontSize + "px").text(e.roleA).node().getBBox();
...
var se = function(t, e, r, u) {
  k = Ft().er, L2.info("Drawing ER diagram");
  ...
  Xe.insertTitle(o, "entityTitleText", k.titleTopMargin, u.db.getDiagramTitle());
  const x = o.node().getBBox(), y = x.width + g * 2, N = x.height + g * 2;
  Sl(o, N, y, k.useMaxWidth), o.attr("viewBox", `${x.x - g} ${x.y - g} ${y} ${N}`);
};
...
//# sourceMappingURL=erDiagram-5298a456-ETK4QC5X.js.map
