...
// node_modules/mermaid/dist/requirementDiagram-3865c41f.js
var ce = function() {
  var e = function(V, i, r, a) {
    ...
    parse: function(i) {
      var r = this, a = [0], n = [], p = [null], s = [], W = this.table, _ = "", Z = 0, me = 0, Ve = 2, Ie = 1, qe = s.slice.call(arguments, 1), g = Object.create(this.lexer), L3 = { yy: {} };
      for (var re in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, re) && (L3.yy[re] = this.yy[re]);
      g.setInput(i, L3.yy), L3.yy.lexer = g, L3.yy.parser = this, typeof g.yylloc > "u" && (g.yylloc = {});
      var se = g.yylloc;
      s.push(se);
      var Oe = g.options && g.options.ranges;
      typeof L3.yy.parseError == "function" ? this.parseError = L3.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function Le() {
        var v;
        return v = n.pop() || g.lex() || Ie, typeof v != "number" && (v instanceof Array && (n = v, v = n.pop()), v = r.symbols_[v] || v), v;
      }
      for (var I, C, S2, ae, Q = {}, ee, $, be, te; ; ) {
        if (C = a[a.length - 1], this.defaultActions[C] ? S2 = this.defaultActions[C] : ((I === null || typeof I > "u") && (I = Le()), S2 = W[C] && W[C][I]), typeof S2 > "u" || !S2.length || !S2[0]) {
          var le = "";
          te = [];
          for (ee in W[C])
...
Expecting ` + te.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : le = "Parse error on line " + (Z + 1) + ": Unexpected " + (I == Ie ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(le, {
        ...
        switch (S2[0]) {
          case 1:
            a.push(I), p.push(g.yytext), s.push(g.yylloc), a.push(S2[1]), I = null, me = g.yyleng, _ = g.yytext, Z = g.yylineno, se = g.yylloc;
            break;
          case 2:
            if ($ = this.productions_[S2[1]][1], Q.$ = p[p.length - $], Q._$ = {
              ...
              return ae;
            $ && (a = a.slice(0, -1 * $ * 2), p = p.slice(0, -1 * $), s = s.slice(0, -1 * $)), a.push(this.productions_[S2[1]][0]), p.push(Q.$), s.push(Q._$), be = W[a[a.length - 2]][a[a.length - 1]], a.push(be);
            break;
          case 3:
            return true;
        }
        ...
        for (var p = this._currentRules(), s = 0; s < p.length; s++)
          if (a = this._input.match(this.rules[p[s]]), a && (!r || a[0].length > r[0].length)) {
            if (r = a, n = s, this.options.backtrack_lexer) {
              if (i = this.test_match(a, p[s]), i !== false)
                return i;
              if (this._backtrack) {
                r = false;
                continue;
...
var it = (e) => (G[e] === void 0 && (G[e] = {
  name: e,
  type: q.type,
  docRef: q.docRef
}, L2.info("Added new requirement: ", e)), q = {}, G[e]);
var nt = () => G;
var rt = (e) => {
  q !== void 0 && (q.type = e);
};
...
var y = {};
var Se = 0;
var Ae = (e, t) => e.insert("rect", "#" + t).attr("class", "req reqBox").attr("x", 0).attr("y", 0).attr("width", y.rect_min_width + "px").attr("height", y.rect_min_height + "px");
var we = (e, t, l) => {
...
var pt = function(e, t, l, c, u) {
  const d = l.edge(H(t.src), H(t.dst)), f = S().x(function(o) {
    return o.x;
  }).y(function(o) {
    return o.y;
  ...
  t.type == u.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + In.getUrl(y.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + In.getUrl(y.arrowMarkerAbsolute) + "#" + xe.ReqMarkers.ARROW + "_line_ending)"
  )), ft(e, h, y, `<<${t.type}>>`);
};
var yt = (e, t, l) => {
  Object.keys(e).forEach((c) => {
    let u = e[c];
    c = H(c), L2.info("Added new requirement: ", c);
...
var Et = (e, t) => (e.forEach(function(l) {
...
var H = (e) => e.replace(/\s/g, "").replace(/\./g, "_");
var Rt = (e, t, l, c) => {
  y = Ft().requirement;
  const u = y.securityLevel;
  let d;
  u === "sandbox" && (d = Ct("#i" + t));
  const h = (u === "sandbox" ? Ct(d.nodes()[0].contentDocument.body) : Ct("body")).select(`[id='${t}']`);
  ...
  yt(E, o, h), _t(R, o, h), Et(A, o), js(o), gt(h, o), A.forEach(function(x) {
    pt(h, x, o, t, c);
  });
  const T = y.rect_padding, N = h.node().getBBox(), w = N.width + T * 2, k = N.height + T * 2;
  Sl(h, k, w, y.useMaxWidth), h.attr("viewBox", `${N.x - T} ${N.y - T} ${w} ${k}`);
};
var mt = {
  draw: Rt
};
...
//# sourceMappingURL=requirementDiagram-3865c41f-BTBTWFM2.js.map
