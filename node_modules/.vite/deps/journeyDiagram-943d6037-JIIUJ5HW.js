...
// node_modules/mermaid/dist/journeyDiagram-943d6037.js
var G = function() {
...
var F = [];
var Tt = function() {
  H.length = 0, V.length = 0, C = "", F.length = 0, Ry();
};
var $t = function(t) {
  C = t, H.push(t);
};
...
var Nt = function(t, e, i) {
  ...
  et++;
  const h = 300 + 5 * 30;
  n.append("line").attr("id", "task" + et).attr("x1", o).attr("y1", e.y).attr("x2", o).attr("y2", h).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Ft2(n, {
    cx: o,
    cy: 300 + (5 - e.score) * 30,
    score: e.score
  });
...
var Ot = function(t, e, i, o) {
  const n = Ft().journey, h = Ft().securityLevel;
  let c2;
  h === "sandbox" && (c2 = Ct("#i" + e));
  ...
  Sl(y, a, u, n.useMaxWidth), y.append("line").attr("x1", P).attr("y1", n.height * 4).attr("x2", u - P - 4).attr("y2", n.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const f = g2 ? 70 : 0;
...
//# sourceMappingURL=journeyDiagram-943d6037-JIIUJ5HW.js.map
