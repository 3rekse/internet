...
// node_modules/mermaid/dist/createText-4be7776a.js
function Tt(n, r) {
...
function Nt(n) {
  ...
  function a(F) {
    if (e < t.length) {
      const L2 = t[e];
      return r.containerState = L2[1], n.attempt(
        L2[0].continuation,
        c,
        p
      )(F);
  ...
  function D(F, L2) {
    ...
    if (L2 && O.push(null), F.previous = l, l && (l.next = F), l = F, u.defineSkip(F.start), u.write(O), r.parser.lazy[F.start.line]) {
...
function Ae(n, r, t) {
  ...
  function F(o) {
    return o === 45 || o === 46 || o === 58 || o === 95 || v(o) ? (n.consume(o), F) : L2(o);
  }
  function L2(o) {
    return o === 61 ? (n.consume(o), O) : q(o) ? (n.consume(o), L2) : _(o);
  }
  function O(o) {
  ...
  function P(o) {
    return o === null || o === 34 || o === 39 || o === 60 || o === 61 || o === 62 || o === 96 || Y(o) ? L2(o) : (n.consume(o), P);
  }
  function R(o) {
...
function Te(n, r, t) {
  ...
  function h(s) {
    return s === 45 ? (n.consume(s), x) : s === 91 ? (n.consume(s), l = "CDATA[", i = 0, D) : tn(s) ? (n.consume(s), L2) : t(s);
  }
  function x(s) {
  ...
  function L2(s) {
    return s === null || s === 62 ? H(s) : C(s) ? (a = L2, W(s)) : (n.consume(s), L2);
  }
  function O(s) {
...
var jr = (n, r = "", {
  ...
  if (L.info("createText", r, t, e, u, l, i, c), l) {
    const p = Tr(r), h = {
      isNode: i,
      label: $b(p).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
//# sourceMappingURL=chunk-S37YXH5X.js.map
