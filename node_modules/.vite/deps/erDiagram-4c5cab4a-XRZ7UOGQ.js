import {
  Graph,
  layout
} from "./chunk-JXZHHQWE.js";
import {
  line
} from "./chunk-IMHSJGCH.js";
...
import {
  ...
  setDiagramTitle,
  utils
} from "./chunk-2CE3RMR5.js";
import "./chunk-YGAUDZUZ.js";

// node_modules/mermaid/dist/erDiagram-4c5cab4a.js
var parser = function() {
...
var drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", getConfig$1().fontFamily).style("font-size", conf.fontSize + "px").text(entities2[entityName].alias ?? entityName);
...
//# sourceMappingURL=erDiagram-4c5cab4a-XRZ7UOGQ.js.map
