...
// node_modules/mermaid/dist/timeline-definition-5dc05eb7.js
var K = function() {
  var n = function(f, i, r, h) {
    ...
    parse: function(i) {
      var r = this, h = [0], d = [], p = [null], l = [], w = this.table, x = "", N = 0, A2 = 0, F = 2, q = 1, W = l.slice.call(arguments, 1), b = Object.create(this.lexer), S = { yy: {} };
      ...
      for (var k, L2, E, Z, z = {}, B2, $, Y, O; ; ) {
        if (L2 = h[h.length - 1], this.defaultActions[L2] ? E = this.defaultActions[L2] : ((k === null || typeof k > "u") && (k = C()), E = w[L2] && w[L2][k]), typeof E > "u" || !E.length || !E[0]) {
          var J = "";
          O = [];
          for (B2 in w[L2])
            this.terminals_[B2] && B2 > F && O.push("'" + this.terminals_[B2] + "'");
...
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : J = "Parse error on line " + (N + 1) + ": Unexpected " + (k == q ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(J, {
        ...
        if (E[0] instanceof Array && E.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + L2 + ", token: " + k);
        switch (E[0]) {
          case 1:
            h.push(k), p.push(b.yytext), l.push(b.yylloc), h.push(E[1]), k = null, A2 = b.yyleng, x = b.yytext, N = b.yylineno, I = b.yylloc;
            break;
          case 2:
    ...
    var f = {
      ...
      setInput: function(i, r) {
        return this.yy = r || this.yy || {}, this._input = i, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
        ...
        for (var p = this._currentRules(), l = 0; l < p.length; l++)
          if (h = this._input.match(this.rules[p[l]]), h && (!r || h[0].length > r[0].length)) {
            if (r = h, d = l, this.options.backtrack_lexer) {
              if (i = this.test_match(h, p[l]), i !== false)
                return i;
              if (this._backtrack) {
                r = false;
                continue;
...
var it = () => Uy;
var rt = function() {
  Q.length = 0, G.length = 0, R = "", V.length = 0, Ry();
};
var at = function(n) {
  R = n, Q.push(n);
};
...
function yt(n, t) {
  n.each(function() {
    var e = Ct(this), a = e.text().split(/(\s+|<br>)/).reverse(), s, c = [], o = 1.1, y = e.attr("y"), g = parseFloat(e.attr("dy")), u = e.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", g + "em");
...
var H = {
  ...
  initGraphics: Pt,
  drawNode: Ht,
  getVirtualNodeHeight: Ct2
};
var Rt = function(n, t, e, a) {
  var W, b;
  const s = Ft(), c = s.leftMargin ?? 50;
  L.debug("timeline", a.db);
  const o = s.securityLevel;
  let y;
  o === "sandbox" && (y = Ct("#i" + t));
  const u = (o === "sandbox" ? Ct(y.nodes()[0].contentDocument.body) : Ct("body")).select("#" + t);
  u.append("g");
  ...
  L.debug("maxSectionHeight before draw", i), L.debug("maxTaskHeight before draw", r), f && f.length > 0 ? f.forEach((S) => {
    ...
    L.debug("sectionNode output", C), P.attr("transform", `translate(${p}, ${d})`), l += i + 50, _.length > 0 && nt(
      u,
      _,
      w,
      p,
  ...
  L.debug("bounds", F), v && u.append("text").text(v).attr("x", F.width / 2 - c).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), h = x ? i + r + 150 : r + 100, u.append("g").attr("class", "lineWrapper").append("line").attr("x1", c).attr("y1", h).attr("x2", F.width + 3 * c).attr("y2", h).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), py(
    void 0,
    u,
    ((W = s.timeline) == null ? void 0 : W.padding) ?? 50,
    ((b = s.timeline) == null ? void 0 : b.useMaxWidth) ?? false
  );
};
var nt = function(n, t, e, a, s, c, o, y, g, u, m) {
  var v;
  for (const f of t) {
    const i = {
      descr: f.task,
    ...
    if (L.debug("taskHeight after draw", d), r.attr("transform", `translate(${a}, ${s})`), c = Math.max(c, d), f.events) {
...
var Wt = (n) => {
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], ci(n["lineColor" + e]) ? n["lineColor" + e] = B(n["lineColor" + e], 20) : n["lineColor" + e] = A(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const a = "" + (17 - 3 * e);
    t += `
...
//# sourceMappingURL=timeline-definition-5dc05eb7-DBWDBKK6.js.map
