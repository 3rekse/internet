...
// node_modules/mermaid/dist/gitGraphDiagram-0775767f.js
var mt = function() {
  var r = function(q, h, b, k) {
    ...
    parse: function(h) {
      ...
      for (var I, K, V, lt, J = {}, it, z, gt, st; ; ) {
        if (K = k[k.length - 1], this.defaultActions[K] ? V = this.defaultActions[K] : ((I === null || typeof I > "u") && (I = Ct2()), V = W[K] && W[K][I]), typeof V > "u" || !V.length || !V[0]) {
          var ht = "";
          st = [];
          for (it in W[K])
...
Expecting ` + st.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : ht = "Parse error on line " + (rt + 1) + ": Unexpected " + (I == bt ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(ht, {
    ...
    var q = {
      ...
      setInput: function(h, b) {
        return this.yy = b || this.yy || {}, this._input = h, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
...
` + b + "^";
      ...
      next: function() {
        ...
        for (var T = this._currentRules(), t = 0; t < T.length; t++)
          if (k = this._input.match(this.rules[T[t]]), k && (!b || k[0].length > b[0].length)) {
            if (b = k, s = t, this.options.backtrack_lexer) {
              if (h = this.test_match(k, T[t]), h !== false)
                return h;
              if (this._backtrack) {
                b = false;
                continue;
        ...
        return b ? (h = this.test_match(b, T[s]), h !== false ? h : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
mt.parser = mt;
var Dt = mt;
var at = Ft().gitGraph.mainBranchName;
var zt = Ft().gitGraph.mainBranchOrder;
var R = {};
var S = null;
var Z = {};
...
function jt(r, a) {
  ...
  return r.reduce((u, n) => {
    const c = a(n);
    return o[c] || (o[c] = true, u.push(n)), u;
  }, []);
}
var qt = function(r) {
  xt = r;
...
var yt = {};
var Yt = function(r) {
  L.debug("options str", r), r = r && r.trim(), r = r || "{}";
  try {
    yt = JSON.parse(r);
  } catch (a) {
    L.error("error while parsing gitGraph options", a.message);
  }
};
var Kt = function() {
  return yt;
};
var Ft2 = function(r, a, o, u) {
  L.debug("Entering commit:", r, a, o, u), a = In.sanitizeText(a, Ft()), r = In.sanitizeText(r, Ft()), u = In.sanitizeText(u, Ft());
  const n = {
    id: a || U + "-" + ft(),
    message: r,
    seq: U++,
  ...
  S = n, R[n.id] = n, L2[v] = n.id, L.debug("in pushCommit " + n.id);
};
var Ut = function(r, a) {
  if (r = In.sanitizeText(r, Ft()), L2[r] === void 0)
    L2[r] = S != null ? S.id : null, Z[r] = { name: r, order: a ? parseInt(a, 10) : null }, _t(r), L.debug("in createBranch");
  else {
    let o = new Error(
...
var Jt = function(r, a, o, u) {
  r = In.sanitizeText(r, Ft()), a = In.sanitizeText(a, Ft());
  const n = R[L2[v]], c = R[L2[r]];
  if (v === r) {
  ...
  S = m, R[m.id] = m, L2[v] = m.id, L.debug(L2), L.debug("in mergeBranch");
};
var Wt = function(r, a, o) {
  if (L.debug("Entering cherryPick:", r, a, o), r = In.sanitizeText(r, Ft()), a = In.sanitizeText(a, Ft()), o = In.sanitizeText(o, Ft()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!a || R[a] === void 0) {
    ...
    S = m, R[m.id] = m, L2[v] = m.id, L.debug(L2), L.debug("in cherryPick");
  }
};
var _t = function(r) {
  if (r = In.sanitizeText(r, Ft()), L2[r] === void 0) {
...
function Et(r) {
  ...
  for (let n in L2)
    L2[n] === a.id && u.push(n);
  if (L.debug(u.join(" ")), a.parents && a.parents.length == 2) {
...
var Qt = function() {
  ...
  L2 = {}, L2[r] = null, Z = {}, Z[r] = { name: r, order: a }, v = r, U = 0, Ry();
};
var Zt = function() {
...
var kt = (r, a, o) => {
  const u = Ll().gitGraph, n = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let m = 0;
...
var ne = (r, a, o) => Object.keys(o).filter((c) => o[c].branch === a.branch && o[c].seq > r.seq && o[c].seq < a.seq).length > 0;
var Q = (r, a, o = 0) => {
...
var le = (r, a) => {
  const o = Ll().gitGraph, u = r.append("g");
  a.forEach((n, c) => {
    ...
    let p = i.getBBox();
    g.attr("class", "branchLabelBkg label" + m).attr("rx", 4).attr("ry", 4).attr("x", -p.width - 4 - (o.rotateCommitLabel === true ? 30 : 0)).attr("y", -p.height / 2 + 8).attr("width", p.width + 18).attr("height", p.height + 4), x.attr(
      "transform",
      "translate(" + (-p.width - 14 - (o.rotateCommitLabel === true ? 30 : 0)) + ", " + (l - p.height / 2 - 1) + ")"
...
var he = function(r, a, o, u) {
  ae();
  const n = Ll(), c = n.gitGraph;
  L.debug("in gitgraph renderer", r + `
`, "id:", a, o), X = u.db.getCommits();
  ...
  }), kt(l, X, false), c.showBranches && le(l, m), oe(l, X), kt(l, X, true), Xe.insertTitle(
    l,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-0775767f-FY2UKL4N.js.map
