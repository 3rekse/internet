...
// node_modules/mermaid/dist/styles-6e7f2b1b.js
var parser = function() {
...
var ClassMember = class {
  constructor(input, memberType) {
    ...
    this.visibility = "";
    this.classifier = "";
    const sanitizedInput = sanitizeText$2(input, getConfig$1());
...
var splitClassNameAndType = function(_id) {
  const id = common$1.sanitizeText(_id, getConfig$1());
  let genericType = "";
  let className = id;
  if (id.indexOf("~") > 0) {
...
var addClass = function(_id) {
  ...
  const name = common$1.sanitizeText(className, getConfig$1());
  classes[name] = {
    id: name,
    type,
    label: name,
...
var setClickFunc = function(_domId, functionName, functionArgs) {
  const domId = common$1.sanitizeText(_domId, getConfig$1());
  const config = getConfig$1();
...
//# sourceMappingURL=chunk-WCKPKXAG.js.map
